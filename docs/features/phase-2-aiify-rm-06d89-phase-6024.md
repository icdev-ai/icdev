# Phase 2 — aiify-rm-06d89-phase-6024 (determination)

**Opportunity:** 6024 (scan_id 43, roadmap `rm-06d89040cf`)
...
`aiify-rm-06d89-phase-5996/5997/6000/6005/6013/6019/6023`) — same
`hardcoded_threshold` → `anomaly_detection` pattern, same `scan_id 43`, same
roadmap `rm-06d89040cf`, same external paperless-ngx `documents/*.py` path family.
It is in particular the **same file** as `aiify-rm-06d89-phase-6023`
(`document_exporter.py`). All prior siblings closed as duplicates of the same commit.
