...
# AI-ify Opportunity 6108 — `ocr_extraction_pipeline` → `llm_generation` (dup of 6118)

- **Kanban task:** `aiify-rm-06d89-phase-6108`
...
5157/6118; roadmap phases 5987/6078/6102/6107 against `tesseract.py`/`barcodes.py`/
...
already-closed `aiify-rm-06d89-phase-6102` and `aiify-rm-06d89-phase-6107`.

## Verification at HEAD (irad/feature, HEAD `2ad4b5ef4`)
