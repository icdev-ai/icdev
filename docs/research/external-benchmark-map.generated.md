...
| 6 | Compliance & ATO | NIST OSCAL, compliance-trestle | Ahead | **No adaptation needed** | 96 | 0 |
...
Measured: **96 modules** (floor 5) → `built`; rows `not_expected`. Surface: `tools/compliance/`.
