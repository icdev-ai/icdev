...
| 6 | Compliance & ATO | NIST OSCAL, compliance-trestle | Ahead | **No adaptation needed** | 97 | 0 |
...
Measured: **97 modules** (floor 5) → `built`; rows `not_expected`. Surface: `tools/compliance/`.
