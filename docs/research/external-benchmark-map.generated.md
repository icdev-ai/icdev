...
| 6 | Compliance & ATO | NIST OSCAL, compliance-trestle | Ahead | **No adaptation needed** | 95 | 0 |
...
Measured: **95 modules** (floor 5) → `built`; rows `not_expected`. Surface: `tools/compliance/`.
