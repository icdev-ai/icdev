...
| 6 | Compliance & ATO | NIST OSCAL, compliance-trestle | Ahead | **No adaptation needed** | 103 | 0 |
...
Measured: **103 modules** (floor 5) → `built`; rows `not_expected`. Surface: `tools/compliance/`.
