...
| 3 | Agent runtime & orchestration | LangGraph, Temporal, OpenAI Agents SDK | Parity | **Parity, with named work** | 121 | 9 |
...
| 7 | Delivery pipeline | Temporal, Argo, GitHub Actions | Ahead | **No adaptation needed** | 108 | 0 |
...
Measured: **121 modules** (floor 5) → `built`; rows `not_assessed`. Surface: `tools/ace/`.
...
Measured: **108 modules** (floor 5) → `built`; rows `not_assessed`. Surface: `tools/kanban/`.
