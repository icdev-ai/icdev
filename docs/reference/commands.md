...
| `kpr-watch-21` | A refusal that names no remedy: the done-gate says what is wrong, not what clears it | *(no CLI; see the record)* | [kpr-watch-21.md](cards/kpr-watch-21.md) |
