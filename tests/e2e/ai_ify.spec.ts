...
//
// It was then RESTATED here rather than shared, which is how the same defect
// came back through fixtures/auth.ts and fixtures/govcon_cpmp.ts
// (qa-fail-0d954757a83824da). One module owns the expression now.
