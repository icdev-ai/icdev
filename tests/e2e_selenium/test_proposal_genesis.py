...
class TestProposalGenesisDashboard:
    ...
    def test_summary_stat_cards_present(self, page: BasePage):
        ...
        daemon_valid = "enabled" in body_text or "disabled" in body_text
    ...
    def test_phase_a_reflexes_table(self, page: BasePage):
        ...
        tier_found = any(term in body_text for term in tier_terms)
        status_found = any(term in body_text for term in status_terms)

        # Step 14: Run buttons
        run_buttons = page.driver.find_elements(
            By.XPATH,
