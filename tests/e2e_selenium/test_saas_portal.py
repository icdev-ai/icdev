...
Prerequisites:
  ...
  - Portal accessible at http://localhost:5000/portal or http://localhost:8443/portal
"""
...
BASE_URL = os.environ.get("ICDEV_PORTAL_URL", "http://localhost:5000")
...
class TestSaasPortalPages:
    ...
    def test_sidebar_navigation_is_consistent(self, page: BasePage):
        ...
        # Sign Out link
        sign_out_links = page.driver.find_elements(
            By.XPATH,
