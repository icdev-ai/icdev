#!/usr/bin/env python3
# CUI // SP-CTI
"""Tests for ClawHub DataBridge Connector."""
...
from tools.databridge.connectors.clawhub_connector import ClawHubConnector  # noqa: E402
...
SAMPLE_SKILL_DETAIL = {
    ...
    "latestVersion": {
        ...
        "changelog": "re-upload after clawhub update",
        "license": "MIT-0",
    },
    "owner": {
        "handle": "pskoett",
...
class TestConnectorProperties:
    ...
    def test_connector_name(self, connector):
        assert connector.connector_name == "clawhub"
...
class TestSearchSkills:
    ...
    @patch("tools.databridge.connectors.clawhub_connector.urlopen")
...
class TestLiveAPI:
    """Live integration tests against clawhub.ai (require network)."""
