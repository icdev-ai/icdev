...
class TestDevSecOpsProfile:
    ...
    def test_get_devsecops_returns_profile(self, client):
        ...
        with patch("tools.saas.rest_api._import_tenant_db") as mock_imp:
            ...
            with patch.dict("sys.modules", {"tools.devsecops.profile_manager": MagicMock()}):
                with patch("tools.saas.rest_api.get_profile", create=True):
...
class TestZTAMaturity:
    ...
    def test_get_zta_returns_scores(self, client):
        ...
        with patch("tools.saas.rest_api._import_tenant_db") as mock_imp:
            ...
            with patch.dict("sys.modules", {"tools.devsecops.zta_maturity_scorer": MagicMock()}):
...
class TestMarketplaceSearch:
    ...
    def test_search_returns_results(self, client):
        ...
        with patch("tools.marketplace.search_engine.search_assets", return_value=mock_results):
    ...
    def test_search_passes_filters(self, client):
        ...
        with patch("tools.marketplace.search_engine.search_assets", return_value=mock_results) as mock_search:
...
class TestSimulations:
    ...
    def test_get_simulations_lists_scenarios(self, client):
        ...
        with patch("tools.saas.rest_api._import_tenant_db") as mock_imp:
            ...
            with patch.dict("sys.modules", {"tools.simulation.simulation_engine": MagicMock()}):
...
class TestMOSAAssessment:
    ...
    def test_get_mosa_returns_assessment(self, client):
        ...
        with patch("tools.saas.rest_api._import_tenant_db") as mock_imp:
            ...
            with patch("tools.compliance.mosa_assessor.MOSAAssessor", return_value=mock_assessor):
...
class TestSupplyChainGraph:
    ...
    def test_get_graph_returns_data(self, client):
        ...
        with patch("tools.saas.rest_api._import_tenant_db") as mock_imp:
            ...
            with patch.dict("sys.modules", {"tools.supply_chain.dependency_graph": MagicMock()}):
