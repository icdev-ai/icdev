...
class TestAgentCardGenerator:
    ...
    def test_generate_card_basic(self):
        from icdev.tools.agent.a2a_agent_card_generator import generate_agent_card
    ...
    def test_generate_all_cards(self):
        from icdev.tools.agent.a2a_agent_card_generator import generate_all_cards
    ...
    def test_list_agents(self):
        from icdev.tools.agent.a2a_agent_card_generator import list_agents
...
class TestAgentTiers:
    ...
    def test_core_agents(self):
        from icdev.tools.agent.a2a_agent_card_generator import _get_agent_tier
...
class TestDiscoveryServer:
    ...
    def test_discover_agents(self):
        from icdev.tools.agent.a2a_discovery_server import discover_agents
    ...
    def test_find_agent_for_skill(self):
        from icdev.tools.agent.a2a_discovery_server import find_agent_for_skill
    ...
    def test_find_agents_by_capability(self):
        from icdev.tools.agent.a2a_discovery_server import find_agents_by_capability
    ...
    def test_discovery_summary(self):
        from icdev.tools.agent.a2a_discovery_server import get_discovery_summary
