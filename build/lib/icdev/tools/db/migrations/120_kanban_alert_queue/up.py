#!/usr/bin/env python3
# CUI // SP-CTI
"""Migration 120 — kanban_alert_queue table.
...
_queue_alert_locally in tools/genesis/reflexes/kanban.py INSERTs rows here
when a task fails so alerts survive DB contention and can be retried.
...
if __name__ == "__main__":
    import sys
    sys.path.insert(0, __file__.split("tools")[0])
    result = up()
    print(result)
