...
def accept_detection(detection_id, accepted_by, db_path=None):
    ...
    from icdev.tools.builder.dev_profile_manager import create_profile, _get_connection
...
def store_detection(detection_results, tenant_id=None, project_id=None,
    ...
    from icdev.tools.builder.dev_profile_manager import _get_connection, _generate_id
