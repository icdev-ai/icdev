...
def _notify(
    ...
    # --- 1. Audit trail ---------------------------------------------------
    try:
        from icdev.tools.audit.audit_logger import log_event  # type: ignore[import-untyped]
    ...
    try:
        from icdev.tools.agent.mailbox import broadcast  # type: ignore[import-untyped]
...
def check_memory_maintenance(
    ...
    try:
        from icdev.tools.memory.auto_capture import flush_buffer, buffer_status
