...
|------|------|-------------|-------|--------|
| Graph Builder | tools/system_graph/graph_builder.py | Federates 6 sources (awareness_kg, canvas_kg, kanban_deps, goals, migrations, codebase) into a unified node/edge list. Runs NetworkX spring_layout + greedy_modularity_communities. 5-min internal cache for node detail lookups. | build_graph(sources, filter_type, filter_health, filter_cluster, search), get_node_detail(node_id) | {nodes, edges, stats} JSON + per-node detail dict |
