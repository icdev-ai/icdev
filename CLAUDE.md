...
- `kpr-watch-21` — A refusal that names no remedy: 10,542 done-gate waits never said `--reverify` — `python tools/kanban/cli.py --reverify <task-id>   # clears "awaiting ICDEV done-verification"` — `docs/reference/cards/kpr-watch-21.md`
