...
| GovCon Product Descriptions | goals/govcon_product_descriptions.md | Product-level proposal content: ICDEV platform and Contract Management Portal (CPMP) as whole products in proposals, product detection logic, knowledge base seeding, Management Volume guidance |
