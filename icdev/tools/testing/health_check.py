...
try:
    from icdev.tools.testing.data_types import CheckResult, HealthCheckResult
except ImportError:
...
def check_tools() -> CheckResult:
    ...
    tool_modules = {
        "icdev.tools.db.init_icdev_db": "Database initialization",
        "icdev.tools.audit.audit_logger": "Audit trail",
        "icdev.tools.compliance.nist_lookup": "NIST control lookup",
        "icdev.tools.security.sast_runner": "SAST scanning",
        "icdev.tools.builder.scaffolder": "Project scaffolding",
    }
