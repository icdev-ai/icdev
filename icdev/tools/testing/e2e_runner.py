...
from icdev.tools.testing.data_types import E2ETestResult
from icdev.tools.testing.utils import make_run_id, setup_logger, ensure_run_dir
...
def _run_vision_validation(results: list, logger, assertions=None, strict=False):
    ...
    """
    try:
        from icdev.tools.testing.screenshot_validator import (
