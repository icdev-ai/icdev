...
SERVER_MODULES = [
    ("core", "icdev.tools.mcp.core_server"),
    ("compliance", "icdev.tools.mcp.compliance_server"),
    ("builder", "icdev.tools.mcp.builder_server"),
    ("infra", "icdev.tools.mcp.infra_server"),
    ("knowledge", "icdev.tools.mcp.knowledge_server"),
    ("maintenance", "icdev.tools.mcp.maintenance_server"),
    ("mbse", "icdev.tools.mcp.mbse_server"),
    ("modernization", "icdev.tools.mcp.modernization_server"),
    ("requirements", "icdev.tools.mcp.requirements_server"),
    ("supply_chain", "icdev.tools.mcp.supply_chain_server"),
    ("simulation", "icdev.tools.mcp.simulation_server"),
    ("integration", "icdev.tools.mcp.integration_server"),
    ("marketplace", "icdev.tools.mcp.marketplace_server"),
    ("devsecops", "icdev.tools.mcp.devsecops_server"),
    ("gateway", "icdev.tools.mcp.gateway_server"),
    ("context", "icdev.tools.mcp.context_server"),
    ("innovation", "icdev.tools.mcp.innovation_server"),
    ("observability", "icdev.tools.mcp.observability_server"),
]
