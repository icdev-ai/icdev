...
def handle_terraform_plan(args: dict) -> dict:
    ...
    generate = _import_tool("icdev.tools.infra.terraform_generator", "generate_terraform")
    if not generate:
...
def handle_ansible_run(args: dict) -> dict:
    ...
    generate = _import_tool("icdev.tools.infra.ansible_generator", "generate_ansible")
    if not generate:
...
def handle_k8s_deploy(args: dict) -> dict:
    ...
    generate = _import_tool("icdev.tools.infra.k8s_generator", "generate_k8s")
    if not generate:
...
def handle_pipeline_generate(args: dict) -> dict:
    ...
    generate = _import_tool("icdev.tools.infra.pipeline_generator", "generate_pipeline")
    if not generate:
...
def handle_rollback(args: dict) -> dict:
    ...
    rollback = _import_tool("icdev.tools.infra.rollback", "rollback_deployment")
    if not rollback:
