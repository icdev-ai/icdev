...
def run_pipeline(source_path, source_language, target_language, output_dir,
    ...
    try:
        from icdev.tools.translation.source_extractor import extract_source
        ir_data = None
    ...
    try:
        from icdev.tools.translation.type_checker import check_all_units, load_type_mappings
    ...
    try:
        from icdev.tools.translation.code_translator import translate_units, _load_config
        from icdev.tools.translation.dependency_mapper import load_mappings, resolve_imports
    ...
    try:
        from icdev.tools.translation.project_assembler import assemble_project
    ...
    try:
        from icdev.tools.translation.translation_validator import validate_translation
    ...
    if translate_tests_flag and source_test_dir:
        try:
            from icdev.tools.translation.test_translator import translate_tests
