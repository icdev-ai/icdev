...
from icdev.tools.testing.data_types import AgentTemplateRequest, AgentPromptRequest, AgentPromptResponse
...
def prompt_claude_code(request: AgentPromptRequest) -> AgentPromptResponse:
    ...
    try:
        from icdev.tools.agent.agent_executor import execute_agent
        from icdev.tools.agent.agent_models import (
    ...
    import subprocess
    from icdev.tools.testing.utils import get_safe_subprocess_env
