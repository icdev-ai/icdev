...
def get_all_sops(sop_type=None, approval_status=None):
    ...
    if sop_type and approval_status:
        sql = "SELECT * FROM mc_sops WHERE sop_type = ? AND approval_status = ? ORDER BY updated_at DESC"
        params = [sop_type, approval_status]
    elif sop_type:
        sql = "SELECT * FROM mc_sops WHERE sop_type = ? ORDER BY updated_at DESC"
        params = [sop_type]
    elif approval_status:
        sql = "SELECT * FROM mc_sops WHERE approval_status = ? ORDER BY updated_at DESC"
