...
def analyze_and_heal(failure_data: dict, dry_run: bool = False, db_path: Path = None) -> dict:
    ...
    from icdev.tools.knowledge.pattern_detector import extract_features, match_known_pattern
...
def record_outcome(
    ...
    try:
        ...
        if event["pattern_id"]:
            from icdev.tools.knowledge.pattern_detector import update_pattern_confidence
