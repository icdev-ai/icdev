...
def generate_zta_security(project_path: str, project_config: dict = None) -> list:
    ...
    try:
        import importlib
        zta_gen = importlib.import_module("icdev.tools.devsecops.zta_terraform_generator")
...
def generate_for_csp(project_path: str, project_config: dict = None,
    ...
    generator_map = {
        "azure": "icdev.tools.infra.terraform_generator_azure",
        "gcp": "icdev.tools.infra.terraform_generator_gcp",
        "oci": "icdev.tools.infra.terraform_generator_oci",
    }
