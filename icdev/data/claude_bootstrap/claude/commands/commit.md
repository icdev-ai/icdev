...
- Examples:
  - `icdev_planner: feat: add user authentication module`
  - `icdev_implementor: bug: fix login validation error`
  - `icdev_planner: chore: update dependencies to latest versions`
