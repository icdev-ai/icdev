# Phase 2 — AI-ify Determination: aiify-rm-06d89-phase-6121

**Opportunity:** 6121 (scan_id 43, roadmap `rm-06d89040cf`)
**Pattern:** `hardcoded_threshold` → `anomaly_detection`
**External module:** `src/paperless/views.py` (paperless-ngx shallow clone `aiify_git_zwu66zfu`)
...
6067 / 6068 / 6071 / 6083 / 6087 / 6088 (all paperless `src/*` files, same pattern).

## Verification (at HEAD `12def1056`, branch `irad/feature`)
