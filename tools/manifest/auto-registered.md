...
| AlphaDesk News Patterns Reflex | tools/genesis/reflexes/alphadesk_news_patterns.py | Genesis AlphaDesk News Patterns Reflex — runs NewsPatternAnalyzer each cycle, emits regime_shift and crackdown patterns, promotes to GKP (GREEN tier) | config dict, trust kernel | Reflex results + GKP export |
