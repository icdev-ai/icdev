...
def generate_feature(
    ...
    lines.append(f"  As a user")
    lines.append(f"  I want to {requirement_text.lower().strip()}")
    lines.append(f"  So that the system meets the specified requirement")
    lines.append("")
    ...
    lines.append(f"    When the user provides invalid input")
    lines.append(f"    Then an appropriate error message is displayed")
    lines.append(f"    And the system remains in a consistent state")
    lines.append("")
...
def _generate_python_steps(
    ...
    for step_type, step_text in step_lines:
        ...
        py_lines.append(f"    # TODO: Implement this step")
...
def _generate_java_steps(
    ...
    lines.append(f" * Generated by ICDEV Builder - test_writer.py")
    lines.append(f" */")
    ...
    for step_type, step_text in step_lines:
        ...
        lines.append(f"        throw new io.cucumber.java.PendingException();")
        lines.append(f"    }}")
        lines.append("")
...
def _generate_go_steps(
    ...
    for step_type, step_text in step_lines:
        ...
        lines.append(f"    // TODO: Implement step - {step_type} {step_text}")
        lines.append(f"    return godog.ErrPending")
        lines.append(f"}}")
        lines.append("")
...
def _generate_csharp_steps(
    ...
    for step_type, step_text in step_lines:
        ...
        lines.append(f"        {{")
        lines.append(f"            // TODO: Implement step - {step_type} {step_text}")
        lines.append(f"            throw new PendingStepException();")
        lines.append(f"        }}")
        lines.append("")
