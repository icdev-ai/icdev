...
CAPABILITY_SOURCES: Dict[str, List[str]] = {
    ...
    "dashboard": [],  # Dashboard stub generated by child_app_generator (not copied from ICDEV)
    "infra": ["tools/infra"],
    "db": ["tools/db"],
...
def build_file_manifest(blueprint: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    conditional = ["multi_agent", "compliance", "security", "mbse", "cicd",
                    "testing", "dashboard", "infra"]
