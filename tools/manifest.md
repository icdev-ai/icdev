...
| NDC Airgap Bundle | tools/network/airgap_bundle.py | Offline air-gap lab bundle builder — tars GNS3/Containerlab binaries + curated images + CycloneDX SBOM + SHA256 signed manifest. For IL5/IL6 enclaves. | CLI `--build --output bundle.tar.gz --images-dir ...`, `--verify bundle.tar.gz` | Bundle manifest + SBOM count |
| Tool | File | Description | Input | Output |
|------|------|-------------|-------|--------|
