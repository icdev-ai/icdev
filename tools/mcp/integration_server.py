...
def create_server() -> MCPServer:
    ...
    server.register_tool(
        ...
        description="Submit a requirements package, COA selection, boundary acceptance, or deployment gate for approval",  # noqa: E501
        input_schema={
            "type": "object",
            "properties": {
    ...
    server.register_tool(
        ...
        description="Build a full Requirements Traceability Matrix linking requirement to SysML to code to test to NIST control",  # noqa: E501
        input_schema={
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "ICDEV project ID"},
