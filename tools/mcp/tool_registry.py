...
TOOL_REGISTRY = {
    ...
    "sbd_assess": {
        ...
        "description": "Run Secure by Design assessment per CISA commitments and DoDI 5000.87 across 14 security domains.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "cmmc_assess": {
        ...
        "description": "Run CMMC Level 2 or Level 3 assessment against a project. Evaluates practices across 14 domains.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "UUID of the project"},
    ...
    "classification_check": {
        ...
        "description": "Validate project classification markings, get marking banners, or query impact level baselines.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "action": {
    ...
    "oscal_validate_deep": {
        ...
        "description": "Run 3-layer deep OSCAL validation: structural → pydantic → Metaschema. Each layer independently optional.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "scan_dependencies": {
        ...
        "description": "Inventory all project dependencies across detected languages (Python, Node.js, Rust, Go, Java, .NET). Reports current version, latest version, and days stale. Use --offline for air-gapped environments where registry access is unavailable.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "check_vulnerabilities": {
        ...
        "description": "Check project dependencies against advisory databases (NVD, GitHub Advisories, pip-audit, npm audit, cargo-audit). Maps findings to SLA deadlines: critical=48hr, high=7d, medium=30d, low=90d.",  # noqa: E501
        "input_schema": {
            "type": "object",
    ...
    "run_maintenance_audit": {
        ...
        "description": "Run a full maintenance audit: dependency inventory, vulnerability check, maintenance score computation (0-100), SLA compliance tracking, trend analysis, and CUI-marked report generation. Gate: score >= 50 required for deployment.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "remediate": {
        ...
        "description": "Auto-implement dependency fixes: update dependency files, create remediation branches, run tests to verify fixes. Medium/low severity auto-fixed; critical/high require manual approval. Use --dry-run to preview changes.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "generate_red_alternative": {
        ...
        "description": "Generate alternative COAs (Courses of Action) for RED-tier requirements that would invalidate ATO",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "ICDEV project ID"},
    ...
    "assess_scrm": {
        ...
        "description": "Run NIST 800-161 Supply Chain Risk Management assessment — per vendor or aggregate project-level",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "ICDEV project ID"},
    ...
    "publish_asset": {
        ...
        "description": "Publish a GOTCHA asset (skill/goal/hardprompt/context/args/compliance) through 7-gate security pipeline",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "research_run_stage": {
        ...
        "description": "Run a specific pipeline stage (SCOPE, LANDSCAPE, REGULATE, COMMUNITY, ACADEMIC, BUILD_BUY, SYNTHESIZE, DOSSIER)",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "research_run_pipeline": {
        ...
        "description": "Run full 8-stage research pipeline: SCOPE → LANDSCAPE → REGULATE → COMMUNITY → ACADEMIC → BUILD_BUY → SYNTHESIZE → DOSSIER",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "shap_analyze": {
        ...
        "description": "Run AgentSHAP Monte Carlo Shapley value analysis on a trace to determine tool importance attribution.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "omb_m25_21_assess": {
        ...
        "description": "Run OMB M-25-21 High-Impact AI assessment. Checks AI inventory, risk classification, oversight plans, and transparency notices.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "Project UUID"},
    ...
    "omb_m26_04_assess": {
        ...
        "description": "Run OMB M-26-04 Unbiased AI assessment. Checks model cards, system cards, bias testing, fairness metrics, and human review processes.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "Project UUID"},
    ...
    "nist_ai_600_1_assess": {
        ...
        "description": "Run NIST AI 600-1 GenAI Profile assessment. Checks confabulation detection, data privacy, information integrity, CBRN safeguards, and value chain transparency.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "Project UUID"},
    ...
    "gao_ai_assess": {
        ...
        "description": "Run GAO-21-519SP AI Accountability assessment. Checks governance, data, performance, and monitoring evidence.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "Project UUID"},
    ...
    "fedramp_ksi_generate": {
        ...
        "description": "Generate FedRAMP 20x KSI evidence for continuous authorization. Maps ICDEV evidence to 43 KSIs across 12 NIST families.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "Project UUID"},
    ...
    "fedramp_authorization_package": {
        ...
        "description": "Bundle FedRAMP 20x authorization package with OSCAL SSP, KSI evidence, and compliance artifacts.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "Project UUID"},
    ...
    "model_card_generate": {
        ...
        "description": "Generate a model card per OMB M-26-04 / Google Model Cards format. Pulls data from AI BOM, telemetry, and XAI assessments.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string"},
    ...
    "system_card_generate": {
        ...
        "description": "Generate a system-level AI card covering the entire AI system (models, tools, agents, data flows, risk profile).",  # noqa: E501
        "input_schema": {
            "type": "object",
    ...
    "ai_transparency_audit": {
        ...
        "description": "Run cross-framework AI transparency audit across all 4 frameworks (OMB M-25-21, M-26-04, AI 600-1, GAO) with gap analysis.",  # noqa: E501
        "input_schema": {
            "type": "object",
    ...
    "confabulation_check": {
        ...
        "description": "Check text output for confabulation (hallucination) indicators using deterministic methods: citation verification, contradiction detection, confidence calibration.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string"},
    ...
    "ai_inventory_register": {
        ...
        "description": "Register an AI use case in the OMB M-25-21 inventory. Classifies risk level (minimal, high-impact, safety-impacting).",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string"},
    ...
    "fairness_assess": {
        ...
        "description": "Assess fairness and bias compliance per OMB M-26-04. Checks documentation evidence for bias testing, fairness metrics, and appeal processes.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {"project_id": {"type": "string"}, "project_dir": {"type": "string"}},
            "required": ["project_id"],
    ...
    "ai_accountability_audit": {
        ...
        "description": "Run cross-framework AI accountability audit across all 4 frameworks with gap analysis and remediation guidance (Phase 49).",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {"project_id": {"type": "string"}, "project_dir": {"type": "string"}},
            "required": ["project_id"],
    ...
    "code_analyze": {
        ...
        "description": "Run AST-based code quality analysis on a project directory. Returns per-function metrics: cyclomatic/cognitive complexity, nesting depth, LOC, smells, maintainability score.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "code_quality_report": {
        ...
        "description": "Get code quality trend report for a project. Shows maintainability over time, complexity distribution, and smell density.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {"project_id": {"type": "string"}},
            "required": ["project_id"],
    ...
    "ironbank_generate": {
        ...
        "description": "Generate Platform One / Iron Bank hardening manifest (hardening_manifest.yaml) and container approval record for DoD Iron Bank submission.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "Project UUID"},
    ...
    "ironbank_validate": {
        ...
        "description": "Validate existing Iron Bank hardening manifest against required fields and Iron Bank submission requirements.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "Project UUID"},
    ...
    "eu_ai_act_classify": {
        ...
        "description": "Run EU AI Act (Regulation 2024/1689) risk classification and compliance assessment. Maps 12 high-risk requirements to ICDEV controls via ISO 27001 bridge.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "project_id": {"type": "string", "description": "Project UUID"},
    ...
    "runtime_feedback_collect": {
        ...
        "description": "Collect runtime feedback from test results. Parses JUnit XML or pytest stdout and correlates test results back to source functions.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "rag_search": {
        ...
        "description": "Search ICDEV RAG knowledge base with natural language query. Returns ranked results from all indexed sources (innovation signals, compliance artifacts, research dossiers, etc.).",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    "rag_ingest": {
        ...
        "description": "Ingest a source type into the RAG vector store. Chunks content, embeds via Ollama nomic-embed-text, and stores with dedup.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "source_type": {
    ...
    "rag_retention_migrate": {
        ...
        "description": "Run tier migration: hot→warm (float16 compression) and warm→cold (metadata only) based on age thresholds.",  # noqa: E501
        "input_schema": {
            "type": "object",
            "properties": {
                "tenant_id": {"type": "string"},
