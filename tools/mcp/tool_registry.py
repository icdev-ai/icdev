...
TOOL_REGISTRY = {
    ...
    "oscal_validate_deep": {
        ...
        "input_schema": {"type": "object", "properties": {"file_path": {"type": "string", "description": "Path to OSCAL JSON file to validate"}, "project_id": {"type": "string", "description": "Project UUID (optional, for logging)"}}, "required": ["file_path"]},
    },
    "oscal_convert": {
        "category": "compliance",
        "module": "tools.mcp.compliance_server",
        ...
        "input_schema": {"type": "object", "properties": {"input_path": {"type": "string", "description": "Path to input OSCAL file"}, "output_format": {"type": "string", "enum": ["json", "xml", "yaml"], "default": "xml", "description": "Target output format"}, "output_path": {"type": "string", "description": "Output file path (optional, auto-generated if omitted)"}}, "required": ["input_path"]},
    },
    "oscal_resolve_profile": {
        ...
        "input_schema": {"type": "object", "properties": {"profile_path": {"type": "string", "description": "Path to OSCAL Profile JSON file"}, "output_path": {"type": "string", "description": "Output path for resolved catalog (optional)"}}, "required": ["profile_path"]},
    },
    "oscal_catalog_lookup": {
        ...
        "input_schema": {"type": "object", "properties": {"control_id": {"type": "string", "description": "Control ID to look up (e.g., AC-2, AC-2(1))"}, "family": {"type": "string", "description": "Family code to list controls (e.g., AC, AU, SC)"}}},
    },
    "oscal_detect_tools": {
        "category": "compliance",
        "module": "tools.mcp.compliance_server",
    ...
    "watch_passive_cve": {
        ...
        "input_schema": {"type": "object", "properties": {"project_id": {"type": "string", "description": "ICDEV\u2122 project ID"}, "action": {"type": "string", "default": "scan", "enum": ["scan", "status"], "description": "'scan' \u2014 process new audit entries; 'status' \u2014 show watcher statistics"}, "since_id": {"type": "number", "description": "Scan audit entries with id > N (default: auto from high-watermark)"}, "no_triage": {"type": "boolean", "default": False, "description": "If true, detect CVEs without auto-triaging them"}}, "required": ["project_id"]},
    },
    # ============================================================
    # SIMULATION (8 tools)
    # ============================================================
    ...
    "review_loop": {
        ...
        "description": "Local review-until-green loop: run ICDEV's gates (ruff lint, coherence, SIPA integrity) over the local diff, apply deterministic autofixes, and iterate until every blocking gate passes or max_iterations. Returns per-iteration scores + a fix_brief of remaining findings for the agent to address.",
        "input_schema": {"type": "object", "properties": {"base": {"type": "string", "description": "git ref to diff HEAD against (e.g. origin/main); omit for working-tree mode"}, "max_iterations": {"type": "integer", "description": "Override max review->fix->re-review cycles (default 3)", "minimum": 1}, "no_autofix": {"type": "boolean", "description": "Report only; do not apply ruff/coherence --fix", "default": False}, "no_audit": {"type": "boolean", "description": "Do not write audit_trail rows", "default": False}, "gate": {"type": "boolean", "description": "Return an error result unless all blocking gates are green", "default": False}}},
    },
}
