...
server.register_tool(
    name="trace_query",
    description="Query traces and spans from the distributed tracing system. Filter by trace_id, project_id, or span name.",  # noqa: E501
    input_schema={
        "type": "object",
        "properties": {
...
server.register_tool(
    name="prov_lineage",
    description="Query W3C PROV provenance lineage for an entity. Trace backward (what produced this?) or forward (what did this produce?).",  # noqa: E501
    input_schema={
        "type": "object",
        "properties": {
...
server.register_tool(
    name="xai_assess",
    description="Run XAI compliance assessment: 10 automated checks covering tracing, provenance, SHAP, and explainability against NIST AI RMF and DoD RAI requirements.",  # noqa: E501
    input_schema={
        "type": "object",
        "properties": {
