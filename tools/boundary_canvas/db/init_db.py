...
_BDC_BACKEND = os.environ.get("BDC_STORAGE_BACKEND", "sqlite").lower()
...
def get_connection():
    ...
    if _BDC_BACKEND == "postgresql":
        try:
            ...
            conn = _icdev_conn(
                db_path=os.environ.get("BDC_PG_DATABASE", "boundary_canvas")
            )
            return conn
        except ImportError:
...
def _tpl_multi_enclave_dod():
    ...
    return {
        "nodes": [
            ...
            {"id": "bnd-ato-1", "type": "bnd-ato", "label": "Program ATO Boundary",
             "x": 20, "y": 20, "width": 1060, "height": 580},
            {"id": "bnd-cui-1", "type": "bnd-classification", "label": "CUI Enclave (IL5)",
             "x": 60, "y": 80, "width": 280, "height": 240},
            {"id": "bnd-secret-1", "type": "bnd-classification", "label": "SECRET Enclave (IL6)",
             "x": 400, "y": 80, "width": 280, "height": 240},
            {"id": "bnd-ts-1", "type": "bnd-classification", "label": "TS/SCI SCIF",
             "x": 740, "y": 80, "width": 280, "height": 240},

            # Systems — centered inside their enclave boundaries
            {"id": "sys-cui-1", "type": "sys-internal", "label": "CUI Mission App",
             "x": 130, "y": 170},
            {"id": "sys-secret-1", "type": "sys-internal", "label": "SECRET C2 System",
             "x": 470, "y": 170},
            {"id": "sys-ts-1", "type": "sys-internal", "label": "TS/SCI Intel System",
             "x": 810, "y": 170},

            # Cross-domain solutions — between enclaves
            {"id": "isa-cds-1", "type": "isa-cross-domain", "label": "CUI-to-SECRET CDS",
             "x": 350, "y": 270},
            {"id": "isa-cds-2", "type": "isa-cross-domain", "label": "SECRET-to-TS CDS",
             "x": 690, "y": 270},

            # Controls row — spaced horizontally
            {"id": "ctrl-fw-main", "type": "ctrl-firewall", "label": "Program Firewall",
             "x": 60, "y": 400},
            {"id": "ctrl-ids-main", "type": "ctrl-ids-ips", "label": "Program IDS/IPS",
             "x": 230, "y": 400},
            {"id": "ctrl-siem-main", "type": "ctrl-siem", "label": "Program SIEM",
             "x": 400, "y": 400},
            {"id": "ctrl-mfa-1", "type": "ctrl-mfa", "label": "MFA Gateway",
             "x": 570, "y": 400},

            # Cloud + VPN + BCAP row
            {"id": "ctrl-bcap-1", "type": "ctrl-bcap", "label": "BCAP",
             "x": 60, "y": 520},
            {"id": "isa-vpn-1", "type": "isa-vpn", "label": "GovCloud VPN",
             "x": 230, "y": 520},
            {"id": "sys-cloud-1", "type": "sys-cloud", "label": "AWS GovCloud",
             "x": 430, "y": 520},

            # Documentation row — bottom
            {"id": "doc-isa-vpn", "type": "doc-isa", "label": "GovCloud ISA",
             "x": 60, "y": 660},
            {"id": "doc-pps-1", "type": "doc-pps-matrix", "label": "PPS Matrix",
             "x": 230, "y": 660},
            {"id": "doc-dfd-1", "type": "doc-dfd", "label": "Data Flow Diagram",
             "x": 400, "y": 660},
            # IaC deployment
            {"id": "doc-iac-1", "type": "doc-conops", "label": "Terraform Landing Zone",
             "x": 600, "y": 660},
        ],
        "edges": [
            # Cross-domain flows
...
def _tpl_fedramp_cloud():
    ...
    return {
        "nodes": [
            ...
            {"id": "bnd-frp-1", "type": "bnd-fedramp", "label": "FedRAMP Authorization Boundary",
             "x": 50, "y": 20, "width": 550, "height": 480,
            ...
            {"id": "sys-csp-1", "type": "sys-cloud", "label": "CSP Infrastructure (IaaS)", "x": 300, "y": 180,
             "properties": {"parent_boundary": "bnd-frp-1"}},
...
def _tpl_healthcare_hipaa():
    ...
    return {
        "nodes": [
            ...
            {"id": "bnd-ato-1", "type": "bnd-ato", "label": "Healthcare ATO Boundary",
             "x": 30, "y": 20, "width": 800, "height": 540,
             "contained_nodes": ["bnd-hipaa-1", "bnd-pci-1", "sys-ehr-1", "sys-billing-1",
                                 "ctrl-fw-1", "ctrl-ids-1", "ctrl-siem-1", "ctrl-dlp-1"]},
            # HIPAA zone — left side inside ATO
            {"id": "bnd-hipaa-1", "type": "bnd-hipaa", "label": "HIPAA PHI Zone",
             "x": 80, "y": 80, "width": 300, "height": 200,
             "contained_nodes": ["sys-ehr-1"]},
            # PCI zone — right side inside ATO
            {"id": "bnd-pci-1", "type": "bnd-pci", "label": "PCI CDE",
             "x": 450, "y": 80, "width": 300, "height": 200,
...
def _tpl_hybrid_multi_cloud():
    ...
    return {
        "nodes": [
            ...
            {"id": "bnd-ato-1", "type": "bnd-ato", "label": "Enterprise ATO Boundary",
             "x": 20, "y": 20, "width": 900, "height": 560,
             "contained_nodes": ["bnd-enc-aws", "bnd-enc-azure", "sys-onprem-1",
                                 "ctrl-fw-1", "ctrl-ids-1", "ctrl-siem-1", "ctrl-bcap-1"]},
            # AWS enclave — left side inside ATO
            {"id": "bnd-enc-aws", "type": "bnd-enclave", "label": "AWS GovCloud Enclave",
             "x": 60, "y": 80, "width": 320, "height": 200,
             "contained_nodes": ["sys-aws-1"]},
            # Azure enclave — right side inside ATO
            {"id": "bnd-enc-azure", "type": "bnd-enclave", "label": "Azure Gov Enclave",
             "x": 450, "y": 80, "width": 320, "height": 200,
...
def _tpl_scca_auth_boundary():
    ...
    return {
        "nodes": [
            ...
            {"id": "bnd-ato-1", "type": "bnd-ato", "label": "SCCA ATO Boundary",
             "x": 20, "y": 20, "width": 1000, "height": 600,
             "contained_nodes": ["bnd-bcap", "bnd-vdss", "bnd-vdms", "bnd-tccm",
                                 "sys-bcap-proxy", "sys-bcap-nfw", "sys-vdss-stack",
                                 "sys-vdms-svc", "sys-tccm-cred",
                                 "ctrl-fw-1", "ctrl-ids-1", "ctrl-siem-1"]},
            # BCAP Zone
            {"id": "bnd-bcap", "type": "bnd-enclave", "label": "BCAP Zone",
             "x": 40, "y": 60, "width": 300, "height": 180,
             "contained_nodes": ["sys-bcap-proxy", "sys-bcap-nfw"]},
            {"id": "sys-bcap-proxy", "type": "sys-internal", "label": "BCAP Proxy",
             "x": 70, "y": 120},
            {"id": "sys-bcap-nfw", "type": "sys-internal", "label": "Network Firewall",
             "x": 220, "y": 120},
            # VDSS Zone
            {"id": "bnd-vdss", "type": "bnd-enclave", "label": "VDSS Zone",
             "x": 370, "y": 60, "width": 300, "height": 180,
             "contained_nodes": ["sys-vdss-stack"]},
            {"id": "sys-vdss-stack", "type": "sys-internal", "label": "Security Stack",
             "x": 450, "y": 120},
            # VDMS Zone
            {"id": "bnd-vdms", "type": "bnd-enclave", "label": "VDMS Zone",
             "x": 40, "y": 280, "width": 300, "height": 180,
             "contained_nodes": ["sys-vdms-svc"]},
            {"id": "sys-vdms-svc", "type": "sys-internal", "label": "Managed Services",
             "x": 120, "y": 340},
            # TCCM Zone
            {"id": "bnd-tccm", "type": "bnd-enclave", "label": "TCCM Zone",
             "x": 370, "y": 280, "width": 300, "height": 180,
             "contained_nodes": ["sys-tccm-cred"]},
            {"id": "sys-tccm-cred", "type": "sys-internal", "label": "Credential Manager",
             "x": 450, "y": 340},
            # Controls
            {"id": "ctrl-fw-1", "type": "ctrl-firewall", "label": "Boundary Firewall",
             "x": 720, "y": 80},
            {"id": "ctrl-ids-1", "type": "ctrl-ids-ips", "label": "IDS/IPS",
             "x": 720, "y": 200},
            {"id": "ctrl-siem-1", "type": "ctrl-siem", "label": "SIEM",
             "x": 720, "y": 320},
            # Interconnections — outside ATO boundary
            {"id": "isa-disn", "type": "isa-dedicated", "label": "DISN/DREN Circuit",
             "x": 720, "y": 480},
            {"id": "isa-vpn-1", "type": "isa-vpn", "label": "VPN to On-Prem",
             "x": 900, "y": 480},
            # Documentation
            {"id": "doc-isa-1", "type": "doc-isa", "label": "DISN ISA",
             "x": 720, "y": 570},
            {"id": "doc-pps-1", "type": "doc-pps-matrix", "label": "PPS Matrix",
             "x": 900, "y": 570},
            # IaC deployment
...
def _tpl_fedramp_agency_auth():
    ...
    return {
        "nodes": [
            # Agency ATO
            {"id": "bnd-ato-1", "type": "bnd-ato", "label": "Agency ATO Boundary",
             "x": 20, "y": 20, "width": 900, "height": 500,
             "contained_nodes": ["bnd-fedramp", "sys-csp", "sys-app",
                                 "ctrl-cap-1", "ctrl-fw-1", "isa-fed-1", "ctrl-mfa-1"]},
            # FedRAMP CSP boundary inside ATO
            {"id": "bnd-fedramp", "type": "bnd-fedramp", "label": "FedRAMP CSP Boundary",
             "x": 60, "y": 60, "width": 350, "height": 200,
             "contained_nodes": ["sys-csp", "sys-app"]},
            {"id": "sys-csp", "type": "sys-cloud", "label": "CSP IaaS",
             "x": 100, "y": 120},
            {"id": "sys-app", "type": "sys-internal", "label": "Agency App",
             "x": 280, "y": 120},
            # Agency On-Prem
            {"id": "sys-dc", "type": "sys-external", "label": "Agency Data Center",
             "x": 500, "y": 120},
            # TIC 3.0 / Identity
            {"id": "ctrl-cap-1", "type": "ctrl-cap", "label": "TIC 3.0 CAP",
             "x": 500, "y": 280},
            {"id": "ctrl-fw-1", "type": "ctrl-firewall", "label": "Agency Firewall",
             "x": 700, "y": 280},
            {"id": "isa-fed-1", "type": "isa-federation", "label": "SAML Federation",
             "x": 100, "y": 280},
            {"id": "ctrl-mfa-1", "type": "ctrl-mfa", "label": "PIV/CAC MFA",
             "x": 280, "y": 280},
            # SaaS providers
            {"id": "sys-saas-idp", "type": "sys-saas", "label": "FedRAMP SaaS (IdP)",
             "x": 100, "y": 400},
            {"id": "sys-saas-siem", "type": "sys-saas", "label": "FedRAMP SaaS (SIEM)",
             "x": 280, "y": 400},
            # Interconnections
            {"id": "isa-vpn-1", "type": "isa-vpn", "label": "Agency VPN",
             "x": 500, "y": 400},
            {"id": "isa-api-1", "type": "isa-api", "label": "SaaS API",
             "x": 700, "y": 400},
            # Documentation
            {"id": "doc-isa-1", "type": "doc-isa", "label": "CSP ISA",
             "x": 100, "y": 520},
            {"id": "doc-pps-1", "type": "doc-pps-matrix", "label": "PPS Matrix",
             "x": 280, "y": 520},
            # IaC deployment
...
def _tpl_lza_ou_structure():
    ...
    return {
        "nodes": [
            ...
            {"id": "bnd-aws-cloud", "type": "bnd-ato", "label": "AWS Cloud (LZA)",
             "x": 20, "y": 20, "width": 1200, "height": 900},
            {"id": "bnd-ou-root", "type": "bnd-enclave", "label": "OU: Root",
             "x": 40, "y": 60, "width": 400, "height": 300},
            {"id": "bnd-ou-security", "type": "bnd-enclave", "label": "OU: Security",
             "x": 480, "y": 60, "width": 700, "height": 300},
            {"id": "bnd-ou-infra", "type": "bnd-enclave", "label": "OU: Infrastructure",
             "x": 40, "y": 400, "width": 500, "height": 250},
            {"id": "bnd-ou-workloads", "type": "bnd-enclave", "label": "OU: Workloads",
             "x": 580, "y": 400, "width": 600, "height": 250},

            # Systems (accounts) — inside their OU boundaries
            {"id": "sys-mgmt", "type": "sys-internal", "label": "Management Account",
             "x": 80, "y": 130},
            {"id": "sys-log-archive", "type": "sys-internal", "label": "Log Archive Account",
             "x": 520, "y": 130},
            {"id": "sys-audit", "type": "sys-internal", "label": "Audit Account (Security-Tooling)",
             "x": 520, "y": 230},
            {"id": "sys-network", "type": "sys-internal", "label": "Network Account (Transit)",
             "x": 80, "y": 470},
            {"id": "sys-shared", "type": "sys-internal", "label": "Shared Services Account",
             "x": 300, "y": 470},
            {"id": "sys-dev", "type": "sys-internal", "label": "Development Workload Account",
             "x": 620, "y": 470},
            {"id": "sys-test", "type": "sys-internal", "label": "Testing Workload Account",
             "x": 800, "y": 470},
            {"id": "sys-prod", "type": "sys-internal", "label": "Production Workload Account",
             "x": 980, "y": 470},

            # Controls
            {"id": "ctrl-sechub", "type": "ctrl-siem", "label": "Security Hub + GuardDuty + Config",
             "x": 750, "y": 130},
            {"id": "ctrl-nfw", "type": "ctrl-firewall", "label": "Network Firewall + Transit GW",
             "x": 80, "y": 560},
            {"id": "ctrl-ct", "type": "ctrl-mfa", "label": "Control Tower + Organizations",
             "x": 80, "y": 230},

            # Documentation
            {"id": "doc-lza", "type": "doc-isa", "label": "LZA Terraform/CloudFormation",
             "x": 250, "y": 230},

            # Interconnections
            {"id": "isa-tgw", "type": "isa-vpn", "label": "Transit Gateway Hub",
             "x": 400, "y": 560},
...
BDC_SNIPPETS = [
    ...
    # 3 — Cross-Domain Solution
    {
        ...
        "graph_json": json.dumps({
            "nodes": [
                {"id": "bnd-cui", "type": "bnd-classification", "label": "CUI Zone", "x": 20, "y": 20,
                 "width": 170, "height": 120, "contained_nodes": ["sys-cui-1"]},
                ...
                {"id": "bnd-secret", "type": "bnd-classification", "label": "SECRET Zone", "x": 340, "y": 20,
                 "width": 170, "height": 120, "contained_nodes": ["sys-secret-1"]},
    ...
    # 7 — DMZ Web Tier
    {
        ...
        "graph_json": json.dumps({
            "nodes": [
                {"id": "bnd-dmz-1", "type": "bnd-dmz", "label": "DMZ", "x": 20, "y": 20,
                 "width": 200, "height": 120, "contained_nodes": ["sys-web-1"]},
    ...
    # 9 — SCCA 4-Zone Pattern
    {
        ...
        "graph_json": json.dumps({
            "nodes": [
                {"id": "bnd-ato-1", "type": "bnd-ato", "label": "SCCA ATO Boundary", "x": 40, "y": 20,
                 "width": 800, "height": 300,
                 "contained_nodes": ["bnd-bcap", "bnd-vdss", "bnd-vdms", "bnd-tccm"]},
                {"id": "bnd-bcap", "type": "bnd-enclave", "label": "BCAP Zone", "x": 60, "y": 80,
                 "width": 160, "height": 120},
                {"id": "bnd-vdss", "type": "bnd-enclave", "label": "VDSS Zone", "x": 260, "y": 80,
                 "width": 160, "height": 120},
                {"id": "bnd-vdms", "type": "bnd-enclave", "label": "VDMS Zone", "x": 460, "y": 80,
                 "width": 160, "height": 120},
                {"id": "bnd-tccm", "type": "bnd-enclave", "label": "TCCM Zone", "x": 660, "y": 80,
                 "width": 160, "height": 120},
            ],
            "edges": [
...
TEMPLATES = [
    ...
    },
    {
        ...
        "tags": json.dumps(["aws", "lza", "landing-zone", "ou", "multi-account",
                            "control-tower", "organizations", "dod"]),
    },
]
...
def init_db():
    ...
    try:
        ...
        for t in TEMPLATES:
            ...
            if not cur.fetchone():
                conn.execute(
                    "INSERT INTO bd_templates (id, name, category, description, graph_json, tags) "
                    "VALUES (?,?,?,?,?,?)",
        ...
        for s in BDC_SNIPPETS:
            ...
            if not cur.fetchone():
                conn.execute(
                    "INSERT INTO bd_snippets (id, name, category, description, graph_json, tags) "
                    "VALUES (?,?,?,?,?,?)",
