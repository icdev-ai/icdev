...
logger = get_logger("icdev.compliance.model_card_generator")
...
def generate_model_card(
    ...
    try:
        ...
        try:
            ...
            logger.warning("generate_model_card: best-effort INSERT into audit_trail failed (non-blocking): %s", exc)
