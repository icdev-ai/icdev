...
|----------|-----------|----------|
| **Critical** | Active exploitation with confirmed data exfiltration or system compromise; mission-critical impact | APT activity, ransomware with data loss, CUI spillage to unclassified system |  # noqa: E501
| **High** | Confirmed malicious activity with potential for significant impact; degraded mission capability | Successful phishing with credential compromise, unauthorized privileged access, malware on production host |  # noqa: E501
| **Moderate** | Suspicious activity requiring investigation; limited operational impact | Failed brute-force attempts, policy violations, unauthorized software installation |  # noqa: E501
| **Low** | Minor policy deviation or informational event; no operational impact | Single failed login, minor configuration drift, expired certificate detected before impact |  # noqa: E501
