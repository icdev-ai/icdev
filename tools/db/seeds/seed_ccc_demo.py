...
_CIRCUITS = [
    (1, "CIR-1001", "100g", "Lumen", 100.0, "POP-Ashburn", "POP-Dallas", "active", "LUM-12345-A", 45000.0, "2023-01-15", "2027-01-14", 72.5),
    (2, "CIR-1002", "100g", "ATT", 100.0, "POP-Ashburn", "POP-Seattle", "active", "ATT-56789-B", 52000.0, "2023-03-01", "2027-02-28", 58.2),
    (3, "CIR-1003", "wavelength", "Zayo", 100.0, "POP-Dallas", "DC-Dallas", "active", "ZAY-98765-C", 38000.0, "2022-11-01", "2026-10-31", 45.0),
    (4, "CIR-1004", "ethernet", "Cogent", 10.0, "DC-Chicago", "POP-Chicago", "active", "COG-11111-D", 8500.0, "2024-01-01", "2026-12-31", 33.1),
    (5, "CIR-1005", "100g", "Verizon", 100.0, "POP-London", "POP-Amsterdam", "active", "VZ-22222-E", 48000.0, "2023-06-01", "2027-05-31", 81.0),
    (6, "CIR-1006", "mpls", "Lumen", 10.0, "DC-Dallas", "DC-Chicago", "active", "LUM-33333-F", 12000.0, "2024-02-01", "2026-01-31", 28.4),
    (7, "CIR-1007", "dark_fiber", "Zayo", 400.0, "POP-Seattle", "POP-Portland", "active", "ZAY-44444-G", 95000.0, "2021-08-01", "2026-07-31", 12.0),
    (8, "CIR-1008", "oc192", "ATT", 10.0, "POP-Miami", "POP-SaoPaulo", "maintenance", "ATT-55555-H", 28000.0, "2022-05-01", "2026-04-30", 0.0),
    (9, "CIR-1009", "ethernet", "Cogent", 1.0, "DC-Ashburn", "POP-Ashburn", "active", "COG-66666-I", 3500.0, "2024-03-01", "2026-02-28", 67.8),
    (10, "CIR-1010", "100g", "Verizon", 100.0, "POP-Dallas", "POP-Houston", "pending", "VZ-77777-J", 46000.0, "2025-01-01", "2028-12-31", 0.0),
    (11, "CIR-1011", "ip_vpn", "Lumen", 1.0, "DC-Chicago", "DC-Dallas", "active", "LUM-88888-K", 6500.0, "2023-09-01", "2026-08-31", 41.2),
    (12, "CIR-1012", "wavelength", "ATT", 100.0, "POP-London", "POP-Frankfurt", "active", "ATT-99999-L", 55000.0, "2023-04-01", "2027-03-31", 55.5),
    (13, "CIR-1013", "ethernet", "Zayo", 10.0, "POP-Amsterdam", "DC-Amsterdam", "active", "ZAY-00000-M", 9200.0, "2024-04-01", "2027-03-31", 19.7),
    (14, "CIR-1014", "100g", "Cogent", 100.0, "POP-Seattle", "POP-Tokyo", "test", "COG-12121-N", 42000.0, "2025-06-01", "2028-05-31", 5.0),
    (15, "CIR-1015", "dark_fiber", "Verizon", 400.0, "POP-Ashburn", "DC-Ashburn", "active", "VZ-23232-O", 88000.0, "2022-01-01", "2027-12-31", 8.5),
]

_CROSS_CONNECTS = [
    (1, "XC-001", "equinix", "EQ-ASH-01", "Port-A1", "Port-Z1", 10.0, "active", 1, 1200.0, "PP-A1", "Cross-connect for CIR-1001"),
    (2, "XC-002", "megaport", "MP-DAL-01", "Port-A2", "Port-Z2", 1.0, "active", 3, 450.0, "PP-A2", "Dallas local handoff"),
    (3, "XC-003", "zayo", "ZAY-SEA-01", "Port-A3", "Port-Z3", 10.0, "active", 2, 850.0, "PP-A3", "Seattle aggregation"),
    (4, "XC-004", "equinix", "EQ-LON-01", "Port-A4", "Port-Z4", 10.0, "active", 5, 1500.0, "PP-A4", "London IX patch"),
    (5, "XC-005", "coresite", "CS-CHI-01", "Port-A5", "Port-Z5", 1.0, "pending_loa", 4, 600.0, "PP-A5", "Chicago pending LOA"),
    (6, "XC-006", "digital_realty", "DR-AMS-01", "Port-A6", "Port-Z6", 10.0, "installing", 13, 1100.0, "PP-A6", "Amsterdam install in progress"),
    (7, "XC-007", "lumen", "LUM-TYO-01", "Port-A7", "Port-Z7", 100.0, "active", 14, 3200.0, "PP-A7", "Tokyo 100G handoff"),
    (8, "XC-008", "equinix", "EQ-ASH-02", "Port-A8", "Port-Z8", 1.0, "active", 11, 500.0, "PP-A8", "Ashburn backup link"),
    (9, "XC-009", "zayo", "ZAY-POR-01", "Port-A9", "Port-Z9", 10.0, "active", 7, 750.0, "PP-A9", "Portland dark fiber patch"),
    (10, "XC-010", "cogent", "COG-MIA-01", "Port-A10", "Port-Z10", 10.0, "suspended", 8, 900.0, "PP-A10", "Miami maintenance"),
]
...
_DWDM_SPANS = [
    (1, "DWDM-001", "Ashburn-Dallas", 8.0, 4.5, 80, 12, 18.5, "operational", "Lumen long-haul"),
    (2, "DWDM-002", "Dallas-Seattle", 12.0, 7.0, 96, 18, 16.2, "operational", "Zayo backbone"),
    (3, "DWDM-003", "London-Amsterdam", 6.0, 3.0, 40, 6, 20.1, "operational", "Euro fiber"),
    (4, "DWDM-004", "Ashburn-Miami", 10.0, 2.0, 160, 14, 17.8, "degraded", "Amplifier replacement needed"),
    (5, "DWDM-005", "Seattle-Tokyo", 20.0, 8.0, 192, 24, 15.5, "operational", "Trans-Pacific"),
    (6, "DWDM-006", "Chicago-Dallas", 8.0, 1.5, 160, 10, 19.2, "operational", "ATT metro"),
]
...
def seed_circuits(conn) -> int:
    sql = """INSERT OR IGNORE INTO ccc_circuits (
        id, circuit_id, circuit_type, carrier, bandwidth_gbps, endpoint_a, endpoint_z, status,
    ...
    for row in _CIRCUITS:
        _safe_execute(conn, sql, (*row, "CUI", _ts(count * 2), _ts(count * 2)))
        count += 1
    return count
...
def seed_cross_connects(conn) -> int:
    sql = """INSERT OR IGNORE INTO ccc_cross_connects (
        id, xc_number, facility, facility_id, port_a, port_z, speed_gbps, status, circuit_id,
        monthly_cost_usd, patch_panel, notes, classification, created_at
    ) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)"""
    count = 0
    for row in _CROSS_CONNECTS:
        _safe_execute(conn, sql, (*row, "CUI", _ts(count * 3)))
        count += 1
    return count
...
def seed_loa_requests(conn) -> int:
    ...
    for row in _LOA_REQUESTS:
        _safe_execute(conn, sql, (*row, "CUI", _ts(count * 5)))
        count += 1
    return count
...
def seed_dwdm_spans(conn) -> int:
    sql = """INSERT OR IGNORE INTO ccc_dwdm_spans (
        id, span_id, fiber_route, total_capacity_tbps, used_capacity_tbps, available_wavelengths,
