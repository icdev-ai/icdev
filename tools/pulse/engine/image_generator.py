...
_TOPIC_VISUAL_MAP = {
    ...
    "network design canvas": "network topology blueprint with routers, switches, firewalls, color-coded security zones, redundancy paths, infrastructure diagram on dark canvas",
    "network intelligence": "network infrastructure analysis dashboard with topology map, device inventory, compliance scoring, redundancy paths between routers and switches",
    "network automation": "automated network infrastructure with Ansible playbooks, device configuration deployment, routers and switches connected in enterprise topology",
