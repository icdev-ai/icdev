...
def run_py_compile(project_dir: str, logger) -> TestResult:
    ...
    return TestResult(
        ...
        test_purpose="Validates Python syntax by compiling source files to bytecode, catching syntax errors like missing colons, invalid indentation, or malformed statements",  # noqa: E501
        ...
        try:
            ...
            if proc.returncode == 0:
                ...
                return TestResult(
                    ...
                    test_purpose="Validates Python code quality using Ruff — identifies unused imports, style violations, security issues, and potential bugs",  # noqa: E501
                    test_type="unit",
        ...
        try:
            ...
            if not passed:
                error_msg = f"{len(high_issues)} HIGH severity issues: " + "; ".join(
                    f"{r.get('test_id')}: {r.get('issue_text', '')} ({r.get('filename', '')}:{r.get('line_number', '')})"  # noqa: E501
            ...
            return TestResult(
                ...
                test_purpose="Static application security testing — identifies common vulnerabilities like SQL injection, XSS, hardcoded secrets, and insecure function calls",  # noqa: E501
                error=error_msg,
                test_type="security",
...
def main():
    ...
    all_results, total_passed, total_failed = run_tests_with_resolution(args.project_dir, run_id, logger)
