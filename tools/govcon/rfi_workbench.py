...
# Section prompt templates are LOADED FROM CONFIG, never hardcoded here.
# This dict previously carried one live solicitation's ROM cost breakdown,
# cost-share figure and statute, teaming options, TRL positioning and risk
# register -- competition-sensitive bid strategy, in a PUBLIC repository.
# Pursuit-neutral defaults: args/govcon/section_prompts.yaml
# Real pursuit content: ICDEV_GOVCON_PROMPTS_PATH (a file outside this repo)
from tools.govcon.section_prompts import get_prompt as _get_section_prompt
...
def generate_section_content(section_id, profile_name, parsed_data):
    ...
    prompt_tpl = _get_section_prompt(item)
