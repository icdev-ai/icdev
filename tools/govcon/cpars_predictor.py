...
Usage:
    ...
    python tools/govcon/cpars_predictor.py --create --contract-id <id> --period-start 2025-01 --period-end 2025-06 --json  # noqa: E501
...
def _score_quality(conn, contract_id):
    ...
    total = conn.execute(
        f"SELECT COUNT(*) FROM cpmp_deliverables WHERE contract_id = ? AND status IN ({placeholders})",
