...
# ---------------------------------------------------------------------------
BLS_SOC_CATALOG = {
    "15-1252": {"title": "Software Developers", "keywords": ["software", "developer", "programming", "code", "application", "api", "microservice", "backend", "frontend", "full stack", "devops"]},
    "15-1212": {"title": "Information Security Analysts", "keywords": ["security", "cybersecurity", "stig", "rmf", "ato", "vulnerability", "penetration", "siem", "incident response", "isso"]},
    "15-1244": {"title": "Network and Computer Systems Administrators", "keywords": ["network", "sysadmin", "system administrator", "infrastructure", "server", "vmware", "active directory", "dns", "dhcp"]},
    "15-1211": {"title": "Computer Systems Analysts", "keywords": ["systems analyst", "requirements", "business analyst", "functional", "process improvement", "gap analysis"]},
    "15-1241": {"title": "Computer Network Architects", "keywords": ["network architect", "network design", "wan", "lan", "sdwan", "zero trust", "network engineering"]},
    "15-1251": {"title": "Computer Programmers", "keywords": ["programmer", "coding", "scripting", "automation", "python", "java", "javascript", "bash"]},
    "15-1232": {"title": "Computer User Support Specialists", "keywords": ["help desk", "tier 1", "tier 2", "end user", "desktop support", "troubleshoot", "service desk"]},
    "15-1231": {"title": "Computer Network Support Specialists", "keywords": ["network support", "network troubleshoot", "network monitor", "noc"]},
    "15-1245": {"title": "Database Administrators and Architects", "keywords": ["database", "dba", "sql", "postgresql", "oracle", "data model", "etl", "data warehouse"]},
    "15-1221": {"title": "Computer and Information Research Scientists", "keywords": ["research", "machine learning", "ai", "artificial intelligence", "nlp", "data science", "algorithm"]},
    "15-2031": {"title": "Operations Research Analysts", "keywords": ["operations research", "optimization", "simulation", "modeling", "analytics", "decision analysis"]},
    "15-2051": {"title": "Data Scientists and Mathematical Science Occupations", "keywords": ["data scientist", "data analytics", "statistical", "predictive", "visualization", "tableau", "power bi"]},
    "17-2061": {"title": "Computer Hardware Engineers", "keywords": ["hardware", "embedded", "firmware", "fpga", "circuit", "pcb", "iot", "edge computing"]},
    "11-3021": {"title": "Computer and Information Systems Managers", "keywords": ["it manager", "program manager", "project manager", "technical lead", "team lead", "scrum master", "agile"]},
    "13-1111": {"title": "Management Analysts", "keywords": ["management consultant", "process improvement", "organizational", "strategic planning", "change management"]},
    "15-1299": {"title": "Computer Occupations, All Other", "keywords": ["cloud", "aws", "azure", "gcp", "kubernetes", "docker", "container", "terraform", "ansible"]},
    "15-1243": {"title": "Database Architects", "keywords": ["data architect", "data modeling", "schema design", "data governance", "master data"]},
    "17-2199": {"title": "Engineers, All Other", "keywords": ["systems engineer", "solution architect", "enterprise architect", "technical architect"]},
    "15-1242": {"title": "Computer Hardware Engineers", "keywords": ["hardware engineer", "component", "integration test"]},
    "13-1161": {"title": "Market Research Analysts", "keywords": ["market research", "competitive analysis", "capture", "business development", "bd"]},
    "43-9011": {"title": "Computer Operators", "keywords": ["operator", "batch processing", "job scheduling", "mainframe"]},
    "15-1253": {"title": "Software Quality Assurance Analysts and Testers", "keywords": ["qa", "quality assurance", "testing", "test automation", "selenium", "playwright", "regression"]},
    "13-1082": {"title": "Project Management Specialists", "keywords": ["pmp", "project management", "scheduling", "earned value", "evm", "milestone", "deliverable"]},
    "11-9199": {"title": "Managers, All Other", "keywords": ["director", "vp", "executive", "oversight", "governance"]},
    "27-3042": {"title": "Technical Writers", "keywords": ["technical writer", "documentation", "user guide", "sop", "procedure", "manual"]},
    "15-1254": {"title": "Web Developers", "keywords": ["web developer", "html", "css", "react", "angular", "vue", "ui", "ux", "frontend"]},
    "13-1199": {"title": "Business Operations Specialists", "keywords": ["operations", "logistics", "supply chain", "procurement"]},
    "33-1099": {"title": "First-Line Supervisors of Protective Service Workers", "keywords": ["physical security", "access control", "guard", "surveillance"]},
    "15-1255": {"title": "Web and Digital Interface Designers", "keywords": ["ux designer", "ui designer", "interaction design", "wireframe", "prototype"]},
    "29-9021": {"title": "Health Information Technologists", "keywords": ["health it", "ehr", "hipaa", "hl7", "fhir", "medical informatics"]},
}

# Complexity keywords for FTE estimation
COMPLEXITY_KEYWORDS = {
    "highly_complex": ["architect", "design", "complex", "enterprise", "large-scale", "migration", "modernization", "transformation"],
...
def _audit(conn, event_type, action, details, opportunity_id=None):
    conn.execute(
        ...
        "VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        (_gen_id("aud"), _now(), event_type, "lcat_mapper", action, json.dumps(details) if isinstance(details, dict) else str(details), opportunity_id, None),
    )
...
def calculate_ftes(tasks, duration_months=12):
    ...
    return {"status": "ok", "allocations": allocations, "total_fte": round(total_fte, 2), "duration_months": duration_months}
...
def store_allocations(opportunity_id, allocations):
    ...
    for alloc in allocations:
        ...
        conn.execute(
            ...
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
            (aid, opportunity_id, alloc["task_description"], alloc["labor_category"],
             alloc["bls_soc_code"], alloc["fte_count"], None, None,
...
def list_allocations(opportunity_id):
    ...
    return {"status": "ok", "opportunity_id": opportunity_id, "allocations": allocations, "count": len(allocations), "total_fte": round(total_fte, 2)}
...
def generate_boe(opportunity_id, tasks=None, allocations=None):
    ...
    for i, alloc in enumerate(allocations, 1):
        desc = (alloc.get("task_description", "")[:60] + "...") if len(alloc.get("task_description", "")) > 60 else alloc.get("task_description", "")
    ...
    boe_text = "\n".join(lines)
    return {"status": "ok", "opportunity_id": opportunity_id, "boe_markdown": boe_text, "allocation_count": len(allocations)}
...
def main():
    ...
    if args.parse_pws:
        ...
        result = {"status": "ok", "message": "Use --parse-pws --map to extract and store allocations first", "existing": existing}
    ...
    if args.json:
        ...
        if "boe_markdown" in result:
            ...
            for a in result["allocations"]:
                print(f"  {a.get('labor_category', 'N/A'):35s} SOC {a.get('bls_soc_code', 'N/A'):10s} FTE {a.get('fte_count', 0):.1f}")
