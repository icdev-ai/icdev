...
Thresholds are loaded from args/alphadesk_correlation_monitor.yaml and
...
_ARGS_PATH = Path(__file__).resolve().parents[3] / "args" / "alphadesk_correlation_monitor.yaml"
...
def _calibrate_thresholds_with_ai(macro_raw: dict, base: dict) -> dict:
    ...
    try:
        ...
        request = LLMRequest(
            ...
            agent_id="alphadesk-anomaly-calibrator",
            classification="CUI",
            max_tokens=120,
            effort="low",
        )
