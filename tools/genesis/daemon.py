...
REFLEX_NAMES = [
    ...
    "idp_score_recorder",   # idp-score-03: 3h scorecard-history append — was scheduled in args/genesis_config.yaml but absent here, so it was never dispatched (found by xbm-wake-01)
]
