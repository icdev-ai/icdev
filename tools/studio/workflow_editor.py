...
TOOL_CATEGORIES: dict[str, dict[str, Any]] = {
    ...
    "compliance": {
        ...
        "tools": [
            ...
            {"id": "fips200_validator", "name": "FIPS 200 Validate",
            ...
            {"id": "compliance_detector", "name": "Framework Detect",
            ...
            {"id": "oscal_tools", "name": "OSCAL Tools",
    ...
    "testing": {
        ...
        "tools": [
            ...
            {"id": "acceptance_validator", "name": "Acceptance Validate",
