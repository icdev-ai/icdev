...
def detect_changes_push(source_manifest: Dict[str, Dict],
                        dest_manifest: Dict[str, Dict],
                        delete_orphans: bool = False) -> List[Dict]:
...
def detect_changes_bidirectional(source_manifest: Dict[str, Dict],
                                 dest_manifest: Dict[str, Dict],
                                 source_prev: Dict[str, Dict],
                                 dest_prev: Dict[str, Dict]) -> List[Dict]:
