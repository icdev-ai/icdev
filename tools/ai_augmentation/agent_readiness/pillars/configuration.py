...
def _load_thresholds() -> dict[str, Any]:
    """Load all configuration-pillar anomaly-detection thresholds.

    Uses the shared load_pillar_config() loader from _base, which reads
    args/agent_readiness_config.yaml and caches the result process-wide.
