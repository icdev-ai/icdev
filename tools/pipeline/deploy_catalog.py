...
HELM_CHARTS = {
    ...
    "argocd": {"repo": "https://argoproj.github.io/argo-helm", "chart": "argo-cd", "version": "7.7.5", "namespace": "ci-cd"},
    "vault": {"repo": "https://helm.releases.hashicorp.com", "chart": "vault", "version": "0.29.1", "namespace": "security"},
    "openbao": {"repo": "https://openbao.github.io/openbao-helm", "chart": "openbao", "version": "0.7.0", "namespace": "security"},
    "sonarqube": {"repo": "https://SonarSource.github.io/helm-chart-sonarqube", "chart": "sonarqube", "version": "10.7.0", "namespace": "quality"},
    "trivy-operator": {"repo": "https://aquasecurity.github.io/helm-charts", "chart": "trivy-operator", "version": "0.24.1", "namespace": "security"},
    "falco": {"repo": "https://falcosecurity.github.io/charts", "chart": "falco", "version": "4.16.1", "namespace": "security"},
    "kube-prometheus-stack": {"repo": "https://prometheus-community.github.io/helm-charts", "chart": "kube-prometheus-stack", "version": "65.8.1", "namespace": "observability"},
    "grafana": {"repo": "https://grafana.github.io/helm-charts", "chart": "grafana", "version": "8.8.2", "namespace": "observability"},
    "loki": {"repo": "https://grafana.github.io/helm-charts", "chart": "loki", "version": "6.22.0", "namespace": "observability"},
    "tempo": {"repo": "https://grafana.github.io/helm-charts", "chart": "tempo", "version": "1.13.2", "namespace": "observability"},
    "kyverno": {"repo": "https://kyverno.github.io/kyverno", "chart": "kyverno", "version": "3.3.4", "namespace": "security"},
    "gatekeeper": {"repo": "https://open-policy-agent.github.io/gatekeeper/charts", "chart": "gatekeeper", "version": "3.18.2", "namespace": "security"},
    "istio-base": {"repo": "https://istio-release.storage.googleapis.com/charts", "chart": "base", "version": "1.24.2", "namespace": "istio-system"},
    "istiod": {"repo": "https://istio-release.storage.googleapis.com/charts", "chart": "istiod", "version": "1.24.2", "namespace": "istio-system"},
    "neuvector": {"repo": "https://neuvector.github.io/neuvector-helm", "chart": "core", "version": "2.8.2", "namespace": "security"},
    "cert-manager": {"repo": "https://charts.jetstack.io", "chart": "cert-manager", "version": "1.16.3", "namespace": "cert-manager"},
    "ingress-nginx": {"repo": "https://kubernetes.github.io/ingress-nginx", "chart": "ingress-nginx", "version": "4.12.0", "namespace": "ingress"},
    "external-secrets": {"repo": "https://charts.external-secrets.io", "chart": "external-secrets", "version": "0.12.1", "namespace": "security"},
    "gitlab-runner": {"repo": "https://charts.gitlab.io", "chart": "gitlab-runner", "version": "0.72.0", "namespace": "ci-cd"},
    "jenkins": {"repo": "https://charts.jenkins.io", "chart": "jenkins", "version": "5.8.3", "namespace": "ci-cd"},
    "nexus": {"repo": "https://sonatype.github.io/helm3-charts", "chart": "nexus-repository-manager", "version": "72.0.0", "namespace": "platform"},
    "linkerd": {"repo": "https://helm.linkerd.io/edge", "chart": "linkerd-control-plane", "version": "2024.12.5", "namespace": "linkerd"},
    "fluentbit": {"repo": "https://fluent.github.io/helm-charts", "chart": "fluent-bit", "version": "0.48.3", "namespace": "observability"},
    "opentelemetry": {"repo": "https://open-telemetry.github.io/opentelemetry-helm-charts", "chart": "opentelemetry-collector", "version": "0.108.0", "namespace": "observability"},
    "wazuh": {"repo": "https://wazuh.github.io/wazuh-kubernetes", "chart": "wazuh", "version": "4.9.2", "namespace": "security"},
    "tekton-pipelines": {"repo": "https://tekton.dev/charts", "chart": "tekton-pipelines", "version": "0.65.0", "namespace": "ci-cd"},
    "gitea": {"repo": "https://dl.gitea.com/charts", "chart": "gitea", "version": "10.6.0", "namespace": "ci-cd"},
    "litmus": {"repo": "https://litmuschaos.github.io/litmus-helm", "chart": "litmus", "version": "3.11.0", "namespace": "litmus"},
...
DEPLOY_CATALOG = {
    # ── Orchestration ────────────────────────────────────────────────────────
    "cicd-gitlab":          {"category": HELM, "helm": "gitlab-runner", "requires_k8s": True, "install_order": 50, "notes": "GitLab Runner on K8s; GitLab server itself is SaaS or separate large Helm deploy"},
    "cicd-jenkins":         {"category": HELM, "helm": "jenkins", "requires_k8s": True, "install_order": 50, "notes": "Jenkins on K8s via Helm; alternatively VM install via Ansible", "vm_fallback": True},
    "cicd-tekton":          {"category": HELM, "helm": "tekton-pipelines", "requires_k8s": True, "install_order": 50, "notes": "Tekton Pipelines CRDs on K8s"},
    "cicd-github-actions":  {"category": SAAS, "notes": "GitHub-hosted runners; no IaC needed. Config via workflow YAML."},
    ...
    "gitops-argocd":        {"category": HELM, "helm": "argocd", "requires_k8s": True, "install_order": 40, "notes": "ArgoCD manages subsequent deployments"},
    "gitops-flux":          {"category": HELM, "requires_k8s": True, "install_order": 40, "notes": "Flux installed via flux bootstrap, not Helm"},
    ...
    "gcp-deploy":           {"category": MANAGED, "terraform": {"gcp": "google_clouddeploy_delivery_pipeline"}, "install_order": 55},
    ...
    # ── Source Control ───────────────────────────────────────────────────────
    "scm-gitlab":           {"category": SAAS, "notes": "GitLab.com SaaS; self-hosted requires massive Helm chart", "helm_optional": "gitlab"},
    "scm-gitea":            {"category": HELM, "helm": "gitea", "requires_k8s": True, "install_order": 30, "notes": "Lightweight Git server on K8s"},
    "scm-forgejo":          {"category": HELM, "requires_k8s": True, "install_order": 30, "notes": "Forgejo community fork of Gitea"},
    ...
    "scan-sonarqube":       {"category": HELM, "helm": "sonarqube", "requires_k8s": True, "install_order": 60, "vm_fallback": True, "notes": "SonarQube server; needs PostgreSQL"},
    ...
    "aws-codeguru":         {"category": MANAGED, "terraform": {"aws": "aws_codegurureviewer_repository_association"}, "install_order": 55},
    ...
    "scan-trivy":           {"category": EPHEMERAL, "notes": "Trivy runs as CI step; Trivy Operator for continuous", "helm_optional": "trivy-operator"},
    ...
    "scan-neuvector":       {"category": HELM, "helm": "neuvector", "requires_k8s": True, "install_order": 70, "notes": "NeuVector runtime + scanning"},
    "aws-inspector":        {"category": MANAGED, "terraform": {"aws": "aws_inspector2_enabler"}, "install_order": 55},
    "az-defender":          {"category": MANAGED, "terraform": {"azure": "azurerm_security_center_subscription_pricing"}, "install_order": 55},
    "gcp-artifact-analysis":{"category": MANAGED, "terraform": {"gcp": "google_project_service"}, "install_order": 55, "notes": "Enable Artifact Analysis API"},
    ...
    "registry-harbor":      {"category": HELM, "helm": "harbor", "requires_k8s": True, "install_order": 35, "notes": "Harbor with Trivy scanner, Notary signing"},
    "registry-nexus":       {"category": HELM, "helm": "nexus", "requires_k8s": True, "install_order": 35, "vm_fallback": True},
    ...
    "package-repo":         {"category": HELM, "helm": "nexus", "requires_k8s": True, "install_order": 35, "notes": "Nexus for PyPI/npm/Maven proxy"},
    ...
    "gcp-binary-auth":      {"category": MANAGED, "terraform": {"gcp": "google_binary_authorization_policy"}, "install_order": 55},
    ...
    # ── Secrets & Keys ───────────────────────────────────────────────────────
    "vault-hashicorp":      {"category": HELM, "helm": "vault", "requires_k8s": True, "install_order": 30, "notes": "Vault with auto-unseal via KMS"},
    ...
    # ── Deploy Targets ───────────────────────────────────────────────────────
    "k8s-cluster":          {"category": MANAGED, "terraform": {"aws": "aws_eks_cluster", "azure": "azurerm_kubernetes_cluster", "gcp": "google_container_cluster", "oci": "oci_containerengine_cluster", "ibm": "ibm_container_cluster", "on_prem": "rke2_cluster"}, "install_order": 10},
    ...
    "openshift":            {"category": MANAGED, "notes": "OpenShift via ROSA (AWS) or ARO (Azure) or self-managed", "install_order": 10},
    "rke2":                 {"category": VM, "ansible": "install_rke2", "install_order": 10, "notes": "RKE2 installed on VMs via Ansible"},
    "k3s":                  {"category": VM, "ansible": "install_k3s", "install_order": 10},
    "deploy-bigbang":       {"category": HELM, "requires_k8s": True, "install_order": 80, "notes": "Big Bang is a Flux-based deployment; needs Flux bootstrap"},
    "deploy-serverless":    {"category": MANAGED, "terraform": {"aws": "aws_lambda_function", "azure": "azurerm_function_app", "gcp": "google_cloudfunctions2_function"}, "install_order": 55},
    ...
    "mon-grafana":          {"category": HELM, "helm": "grafana", "requires_k8s": True, "install_order": 60, "notes": "Included in kube-prometheus-stack; standalone chart also available"},
    ...
    "mon-elk":              {"category": HELM, "requires_k8s": True, "install_order": 60, "notes": "ELK stack via ECK operator or Bitnami chart"},
    ...
    "az-sentinel":          {"category": MANAGED, "terraform": {"azure": "azurerm_sentinel_log_analytics_workspace_onboarding"}, "install_order": 55},
    "gcp-monitoring":       {"category": MANAGED, "terraform": {"gcp": "google_monitoring_notification_channel"}, "install_order": 55},
    ...
    # ── Compliance & Audit ───────────────────────────────────────────────────
    "comp-dashboard":       {"category": HELM, "requires_k8s": True, "install_order": 75, "notes": "Custom compliance dashboard or IBM SCC"},
    ...
    "comp-stigman":         {"category": HELM, "requires_k8s": True, "install_order": 75, "notes": "STIG Manager web app on K8s"},
    ...
    "aws-audit":            {"category": MANAGED, "terraform": {"aws": "aws_auditmanager_account_registration"}, "install_order": 55},
    "az-defender-cloud":    {"category": MANAGED, "terraform": {"azure": "azurerm_security_center_subscription_pricing"}, "install_order": 55},
    ...
    "cds-emulator":         {"category": VM, "ansible": "install_cds_emulator", "install_order": 80, "notes": "Dev/test CDS emulator on VM"},
    ...
    "vuln-db-mirror":       {"category": VM, "ansible": "setup_vuln_mirror", "install_order": 25, "notes": "Mirror NVD/OSV on VM with scheduled updates"},
    "package-mirror":       {"category": VM, "ansible": "setup_package_mirror", "install_order": 25, "notes": "devpi/Verdaccio/Athens on VM"},

    # ── Service Mesh ─────────────────────────────────────────────────────────
    "mesh-istio":           {"category": HELM, "helm": "istiod", "requires_k8s": True, "install_order": 45, "notes": "Install istio-base first, then istiod"},
    ...
    "sre-chaos-litmus":     {"category": HELM, "helm": "litmus", "requires_k8s": True, "install_order": 75, "notes": "LitmusChaos operator on K8s"},
    "aws-fis":              {"category": MANAGED, "terraform": {"aws": "aws_fis_experiment_template"}, "install_order": 75},
    "az-chaos-studio":      {"category": MANAGED, "terraform": {"azure": "azurerm_chaos_studio_experiment"}, "install_order": 75},
    ...
    "aws-cw-slo":           {"category": MANAGED, "terraform": {"aws": "aws_cloudwatch_service_level_objective"}, "install_order": 60},
    "aws-incident-mgr":     {"category": MANAGED, "terraform": {"aws": "aws_ssmincidents_response_plan"}, "install_order": 65},
    "gcp-service-mon":      {"category": MANAGED, "terraform": {"gcp": "google_monitoring_slo"}, "install_order": 60},
    "az-advisor-rel":       {"category": MANAGED, "notes": "Azure Advisor reliability — subscription-level, no Terraform resource"},
    ...
    "sre-sloth":            {"category": EPHEMERAL, "notes": "Sloth generates Prometheus rules from SLO YAML — CLI tool, no service"},
    ...
    "sre-grafana-oncall":   {"category": HELM, "requires_k8s": True, "install_order": 65, "notes": "Grafana OnCall open-source on-call"},
    "sre-opsgenie":         {"category": SAAS, "notes": "Atlassian Opsgenie SaaS"},
    "sre-backstage":        {"category": HELM, "requires_k8s": True, "install_order": 70, "notes": "Backstage developer portal"},
    "sre-circuit-breaker":  {"category": BOUNDARY, "notes": "Circuit breaker pattern — code-level, ICDEV circuit_breaker.py"},
    ...
    "onprem-datacenter":    {"category": VM, "ansible": "provision_vm", "install_order": 5, "notes": "On-premises data center"},
...
def resolve_dependencies(nodes):
    ...
    needs_k8s = any(
        get_deploy_info(n.get("type", "")).get("requires_k8s", False)
        for n in nodes
    )
    ...
    return {
        ...
        "helm_releases": sorted(set(
            item["deploy"]["helm"]
            for item in classified[HELM]
            if item["deploy"].get("helm")
        )),
        "managed_resources": [
        ...
        "vm_playbooks": sorted(set(
            item["deploy"]["ansible"]
            for item in classified[VM]
            if item["deploy"].get("ansible")
        )),
        "saas_integrations": [
            {"type": item["node"].get("type"), "notes": item["deploy"].get("notes", "")}
            for item in classified[SAAS]
        ],
        "ci_steps": [
            {"type": item["node"].get("type"), "label": item["node"].get("label", "")}
            for item in classified[EPHEMERAL]
        ],
    }
