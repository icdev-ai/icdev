        ...
        "graph_json": json.dumps(
            {
                "nodes": [
                    ...
                    _node("jwics-dns",  "JWICS DNS Resolver",       "server",        970, 140, {"config": {"classification": "SECRET", "zones": "*.jwics.gov, *.dia.smil.mil", "dnssec": "yes", "notes": "DIA-managed recursive resolver. No Internet DNS. DNSSEC with NSS PKI keys."}}),
        ...
        "graph_json": json.dumps(
            {
                "nodes": [
                    ...
                    _node("jwics-rec",     "JWICS Recursive\nResolver",    "server",       480, 280, {"config": {"classification": "SECRET", "managed_by": "DIA", "zones": "*.jwics.gov, *.dia.smil.mil, *.smil.mil", "dnssec": "yes"}}),
                    _node("dia-auth",      "DIA Authoritative\nDNS",       "server",       700, 280, {"config": {"classification": "SECRET", "authoritative_for": "*.jwics.gov, *.dia.smil.mil", "dnssec_signed": "yes"}}),
