...
try:
    ...
    from azure.keyvault.keys.crypto import CryptographyClient, EncryptionAlgorithm  # noqa: F401
    from azure.identity import DefaultAzureCredential as _AzureCredKMS  # noqa: F401
...
# ============================================================
try:
    from google.cloud import kms as _gcp_kms  # noqa: F401
