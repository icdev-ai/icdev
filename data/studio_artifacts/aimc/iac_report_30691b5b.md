...
|----------|------|---------|
| `main_30691b5b.tf` | Terraform | AWS AI/ML infrastructure |
| `variables.tf` | Terraform | Variable declarations |
| `ansible_playbook_30691b5b.yml` | Ansible | ML runtime environment setup |
| `validate_30691b5b.py` | Python | Post-deploy boto3 validation |
...
python ../validate_30691b5b.py --region us-gov-west-1
```
