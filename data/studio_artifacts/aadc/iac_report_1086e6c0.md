...
|----------|------|---------|
| `main_1086e6c0.tf` | Terraform | AWS agentic AI infrastructure |
| `variables.tf` | Terraform | Variable declarations |
| `ansible_playbook_1086e6c0.yml` | Ansible | Lambda layer + API key rotation |
| `validate_1086e6c0.py` | Python | Post-deploy boto3 validation |
...
python ../validate_1086e6c0.py --region us-gov-west-1
```
