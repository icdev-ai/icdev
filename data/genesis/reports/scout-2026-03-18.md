...
- **Latest Release:** v2.1.78 (2026-03-17)
...
- **Latest Release:** v4.0.0 (2026-03-16)
- **Notes:** ## v4.0.0 (2026-03-16)

_This release is published under the Apache-2.0 License._

### Bug Fixes

- Add missing optional fields to Parameter and Property constructors ([#2047](https://github.com/oscal...
...
- **Latest Release:** v0.18.1 (2026-03-17)
- **Notes:** ### Web Search and Fetch in OpenClaw

Ollama now ships with web search and web fetch plugin for OpenClaw. This allows Ollama's models (local or cloud) to search the web for the latest content and ne...
