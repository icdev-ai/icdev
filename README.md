...
- **Anti-hallucination consistency** — the deterministic confabulation detector is wired into RFI, proposals, and DIC generation. DIC document generation is TRUST-compliant by default: leaked Chain-of-Thought / Chain-of-Debate reasoning is scrubbed, and any residual is flagged for HITL rather than published.
