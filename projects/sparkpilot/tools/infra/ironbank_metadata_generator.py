...
# Generated: {timestamp}
# Generator: SPARKPILOT Iron Bank Metadata Generator (D350)
apiVersion: v1
name: "{project_name}"
tags:
  - "{project_name}:latest"
...
image_author:
  name: "SPARKPILOT Auto-Generator"
  email: "sparkpilot@{project_slug}.mil"
...
vulnerability_report:
  - url: "{vuln_scan_url}"
    description: "SBOM and vulnerability scan — generated by SPARKPILOT sbom_generator.py"
...
def generate_hardening_manifest(
    ...
    Args:
        ...
        db_path: Path to SPARKPILOT database (optional).
    ...
    description = "SPARKPILOT-generated hardened container"
    impact_level = "IL4"
    classification = "CUI"
    version = "1.0.0"
