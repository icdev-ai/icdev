...
def generate_python(project_path: str, config: dict = None) -> list:
    ...
    project_name = config.get("project_name", "sparkpilot-app")
...
def main():
    ...
    parser.add_argument("--project-name", default="sparkpilot-app", help="Project name for labels")
