...
resource "kubernetes_namespace" "main" {
  metadata {
    name = var.namespace
    labels = {
      "app.kubernetes.io/managed-by" = "sparkpilot-terraform"
      "sparkpilot/classification"          = var.classification
      "sparkpilot/environment"             = var.environment
    }
  }
}
...
# PostgreSQL database for SPARKPILOT
resource "postgresql_database" "sparkpilot" {
...
output "database_name" {
  ...
  value       = postgresql_database.sparkpilot.name
}
"""
...
resource "docker_network" "sparkpilot" {
...
def generate(project_name: str = "sparkpilot", environment: str = "production",
...
def run_cli():
    ...
    parser.add_argument("--project-id", default="sparkpilot", help="Project name")
