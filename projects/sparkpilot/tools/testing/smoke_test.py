# [TEMPLATE: CUI // SP-CTI]
# SPARKPILOT Smoke Test — verify all CLI tools are importable and --help works
# Catches import errors after bulk refactors (renames, ruff cleanup, etc.)

"""
SPARKPILOT Smoke Test — validates all CLI tools compile and respond to --help.
...
def main():
    parser = argparse.ArgumentParser(
        description="SPARKPILOT Smoke Test — verify all CLI tools compile and --help works"
    )
    ...
    if not args.json:
        ...
        print(f"SPARKPILOT Smoke Test — {mode_label}")
        print("=" * 60)
