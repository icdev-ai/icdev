...
DB_PATH = PROJECT_ROOT / "data" / "sparkpilot.db"
...
REMEDIATION_REGISTRY: Dict[str, dict] = {
    ...
    "SEC-002": {
        ...
        "command": [
            ...
            "--project-id", "sparkpilot-platform", "--auto", "--json",
        ],
        "suggestion": None,
    },
    "INT-002": {
    ...
    "AI-001": {
        ...
        "command": [
            ...
            "--project-id", "sparkpilot-platform", "--register", "--name", "default", "--json",
        ],
        "suggestion": None,
    },
    "AI-002": {
        ...
        "command": [
            ...
            "--project-id", "sparkpilot-platform", "--model-name", "default", "--json",
        ],
        "suggestion": None,
    },
    "AI-003": {
        ...
        "command": [
            ...
            "--project-id", "sparkpilot-platform", "--json",
        ],
        "suggestion": None,
    },
...
def run_remediation(
    ...
    if stream:
        print("\n" + "=" * 60, file=sys.stderr)
        print("  SPARKPILOT Production Remediation", file=sys.stderr)
...
def _format_human(report: RemediationReport) -> str:
    ...
    lines.append("")
    lines.append("=" * 60)
    lines.append("  SPARKPILOT Production Remediation Report")
    lines.append("=" * 60)
    lines.append("")
...
def main():
    parser = argparse.ArgumentParser(
        description="SPARKPILOT Production Remediation — auto-fix audit blockers"
    )
