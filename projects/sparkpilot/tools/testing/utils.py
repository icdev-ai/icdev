# [TEMPLATE: CUI // SP-CTI]
# SPARKPILOT Testing Utilities
# Adapted from ADW utils.py for Gov/DoD testing workflows

"""Utility functions for SPARKPILOT testing framework.
...
def setup_logger(run_id: str, phase: str = "test_run") -> logging.Logger:
    ...
    logger.info(f"SPARKPILOT Test Logger initialized - Run: {run_id}, Phase: {phase}")
...
def get_safe_subprocess_env() -> Dict[str, str]:
    ...
    Adapted from ADW get_safe_subprocess_env with SPARKPILOT-specific variables.
    ...
    """
    safe_env_vars = {
        # SPARKPILOT Configuration
        "ICDEV_DB_PATH": os.getenv("ICDEV_DB_PATH", str(PROJECT_ROOT / "data" / "sparkpilot.db")),
