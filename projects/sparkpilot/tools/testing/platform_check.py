#!/usr/bin/env python3
# CUI // SP-CTI
"""SPARKPILOT Platform Compatibility Checker.

Validates that the current OS environment can run SPARKPILOT tools.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="SPARKPILOT platform compatibility check")
    ...
    if args.json:
        ...
        print(f"SPARKPILOT Platform Check -- {PLATFORM_NAME}")
        print("=" * 50)
        for r in results:
