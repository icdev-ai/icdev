# [TEMPLATE: CUI // SP-CTI]
# SPARKPILOT Testing Data Types
# Adapted from ADW data_types.py for Gov/DoD testing workflows

"""Pydantic data models for SPARKPILOT testing framework.
...
class HealthCheckResult(BaseModel):
    """Aggregate health check results for the SPARKPILOT system."""
    success: bool
    timestamp: str
...
# --- Compliance Gate Types (SPARKPILOT-specific) ---
...
class GateEvaluation(BaseModel):
    ...
    evaluated_by: str = "sparkpilot-testing"
...
class AgentTemplateRequest(BaseModel):
    ...
    agent_name: str
    slash_command: str  # e.g., "/sparkpilot-test", "/sparkpilot-secure"
    args: List[str] = []
    run_id: str = ""
    model: Literal["sonnet", "opus", "haiku"] = "sonnet"
