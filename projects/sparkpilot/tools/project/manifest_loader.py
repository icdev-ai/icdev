#!/usr/bin/env python3
# CUI // SP-CTI
"""Parse and validate sparkpilot.yaml project manifests.

Reads sparkpilot.yaml from a project directory, validates structure and
...
Usage:
    ...
    python tools/project/manifest_loader.py --file /path/to/sparkpilot.yaml --validate
"""
...
MANIFEST_FILENAME = "sparkpilot.yaml"
MANIFEST_VERSION = 1
...
def load_manifest(directory: str = None, file_path: str = None) -> dict:
    """Load and parse sparkpilot.yaml from a directory or explicit path.

    Args:
        directory: Directory containing sparkpilot.yaml (defaults to cwd).
        file_path: Explicit path to an sparkpilot.yaml file (overrides directory).
...
def main():
    parser = argparse.ArgumentParser(
        description="Parse and validate sparkpilot.yaml project manifests"
    )
    parser.add_argument("--dir", help="Project directory containing sparkpilot.yaml")
    parser.add_argument("--file", help="Explicit path to sparkpilot.yaml")
