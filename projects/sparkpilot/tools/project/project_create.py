#!/usr/bin/env python3
# CUI // SP-CTI
"""Create a new SPARKPILOT-managed project.

Generates a UUID, creates the project directory under projects/, scaffolds the
directory structure based on project type, inserts a record into sparkpilot.db,
...
def main():
    parser = argparse.ArgumentParser(
        description="Create a new SPARKPILOT-managed project"
    )
    parser.add_argument(
        "--name", required=True,
