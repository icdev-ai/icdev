...
logger = logging.getLogger("sparkpilot.llm.gemini")
...
def _convert_messages_to_gemini(
    ...
    """Convert SPARKPILOT universal messages to Gemini content format.
...
def _convert_tools_to_gemini(tools: List[Dict]) -> List[Any]:
    """Convert SPARKPILOT/OpenAI tool format to Gemini function declarations.
