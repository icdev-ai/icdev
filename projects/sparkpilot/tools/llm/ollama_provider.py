...
(used internally by SPARKPILOT's LLMRequest) and converts it to Ollama's
...
logger = logging.getLogger("sparkpilot.llm.ollama")
...
def _convert_messages_to_ollama(messages: List[Dict[str, Any]],
    ...
    """Convert SPARKPILOT universal messages to Ollama native chat format.
