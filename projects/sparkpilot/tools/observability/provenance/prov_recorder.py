...
logger = logging.getLogger("sparkpilot.observability.provenance")
...
class ProvRecorder:
    ...
    def export_prov_json(self, project_id: Optional[str] = None) -> Dict:
        ...
        try:
            ...
            return {
                "prefix": {"prov": "http://www.w3.org/ns/prov#", "sparkpilot": "urn:sparkpilot:"},
                "entity": {
                    e["id"]: {
                        "prov:type": e["entity_type"],
                        "prov:label": e["label"],
                        "sparkpilot:content_hash": e["content_hash"],
                    }
                    for e in entities
                },
                "activity": {
