...
Usage:
    ...
    tracer = OTelTracer(service_name="sparkpilot-builder", endpoint="http://localhost:4317")
...
class OTelTracer(Tracer):
    ...
    def __init__(
        ...
        self._tracer = otel_trace.get_tracer("sparkpilot.observability", "0.1.0")
