...
def score_ai_governance_readiness(project_id: str, conn: sqlite3.Connection = None,
    ...
    close_conn = False
    if conn is None:
        path = db_path or (BASE_DIR / "data" / "sparkpilot.db")
    ...
    if components["inventory_registered"] == 0.0:
        gaps.append({
            ...
            "remediation": "Register AI systems via /sparkpilot-transparency inventory",
        })
    ...
    if components["model_cards_present"] == 0.0:
        gaps.append({
            ...
            "remediation": "Create model cards via /sparkpilot-transparency model-card",
        })
    ...
    if components["oversight_plan_exists"] == 0.0:
        gaps.append({
            ...
            "remediation": "Register oversight plan via /sparkpilot-accountability",
        })
    ...
    if components["impact_assessment_done"] == 0.0:
        gaps.append({
            ...
            "remediation": "Run impact assessment via /sparkpilot-accountability",
        })
    ...
    if components["caio_designated"] == 0.0:
        gaps.append({
            ...
            "remediation": "Designate CAIO via /sparkpilot-accountability",
        })
