...
"""Scenario Manager for the SPARKPILOT RICOAS Digital Program Twin.
...
Databases:
    - data/sparkpilot.db: simulation_scenarios, simulation_results, monte_carlo_runs
"""
