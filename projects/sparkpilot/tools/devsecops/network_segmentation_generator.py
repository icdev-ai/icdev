...
_CUI_HEADER = (
    ...
    "# Generated: {timestamp}\n"
    "# Generator: SPARKPILOT Network Segmentation Generator\n"
...
_ZTA_LABELS = {
    "sparkpilot.mil/component": "zta-network-segmentation",
    "sparkpilot.mil/classification": "CUI",
...
def _get_db():
    """Open connection to SPARKPILOT SQLite database."""
        ...
        deny_ingress = {
            ...
            "metadata": {
                ...
                "labels": _zta_labels({
                    ...
                    "sparkpilot.mil/namespace": ns,
                }),
                "annotations": {
                    "sparkpilot.mil/classification": "CUI",
                    "sparkpilot.mil/generated": datetime.now(timezone.utc).isoformat(),
                    "sparkpilot.mil/nist-controls": "AC-3,AC-4,SC-7",
                    "sparkpilot.mil/purpose": "ZTA default-deny ingress — blocks all inbound traffic",
                },
            },
            "spec": {
                "podSelector": {},
        ...
        deny_egress = {
            ...
            "metadata": {
                ...
                "annotations": {
                    "sparkpilot.mil/classification": "CUI",
                    "sparkpilot.mil/generated": datetime.now(timezone.utc).isoformat(),
                    "sparkpilot.mil/nist-controls": "AC-3,AC-4,SC-7,SC-8",
                    "sparkpilot.mil/purpose": "ZTA default-deny egress — DNS-only exception to kube-system",
                },
            },
            "spec": {
                "podSelector": {},
        ...
        netpol = {
            ...
            "metadata": {
                ...
                "labels": _zta_labels({
                    ...
                    "sparkpilot.mil/service": svc_name,
                }),
                "annotations": {
                    "sparkpilot.mil/classification": "CUI",
                    "sparkpilot.mil/generated": datetime.now(timezone.utc).isoformat(),
                    "sparkpilot.mil/nist-controls": "AC-3,AC-4,SC-7,SC-8,SC-13",
                    "sparkpilot.mil/purpose": (
                        f"ZTA micro-segmentation for {svc_name} — "
                        f"port-level ingress/egress restricted to port {svc_port}"
                    ),
                    "sparkpilot.mil/zta-maturity": "optimal",
                },
            },
            "spec": {
                "podSelector": {
...
def main():
    ...
    if use_json:
        ...
        print("=" * 70)
        print("SPARKPILOT Network Segmentation Generator — ZTA Micro-Segmentation")
