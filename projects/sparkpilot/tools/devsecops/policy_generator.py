                    ...
                    "pattern": {
                        "metadata": {
                            "labels": {
                                ...
                                "sparkpilot.mil/classification": f"{classification}",
                            }
                        }
                    },
                },
            ...
            "rules": [{
                ...
                "validate": {
                    ...
                    "deny": {
                        "conditions": {
                            "any": [{
                                "key": "{{request.object.metadata.labels.\"sparkpilot.mil/network-policy\"}}",
                                "operator": "Equals",
                                "value": "",
                            }]
                        }
        ...
        config = {
            ...
            "metadata": {
                ...
                "labels": {
                    ...
                    "sparkpilot.mil/component": "devsecops-policy-engine",
                },
            },
        }
        return {
