...
"""Service Mesh Configuration Generator for SPARKPILOT.
...
the ZTA profile. PDP is modeled as an external reference — SPARKPILOT generates
...
ADR D124: PDP modeled as external reference; SPARKPILOT generates PEP configs only.
"""
...
DB_PATH = Path(os.environ.get("ICDEV_DB_PATH", str(BASE_DIR / "data" / "sparkpilot.db")))
...
def _get_db():
    """Get an SPARKPILOT database connection with WAL mode and Row factory."""
...
def _mesh_labels(project_id: str, component: str, classification: str = "CUI") -> dict:
    """Return standard SPARKPILOT service mesh labels for a K8s resource."""
    return {
        "sparkpilot.mil/project": project_id,
        "sparkpilot.mil/component": component,
        "sparkpilot.mil/classification": classification,
...
def _istio_peer_authentication(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "sparkpilot.mil/generated": datetime.now(timezone.utc).isoformat(),
                "sparkpilot.mil/adr": "D121",
                "sparkpilot.mil/description": "Namespace-wide STRICT mTLS enforcement",
            },
        },
        "spec": {
...
def _istio_authorization_policy(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "sparkpilot.mil/generated": datetime.now(timezone.utc).isoformat(),
                "sparkpilot.mil/adr": "D124",
                "sparkpilot.mil/pdp-references": pdp_annotation,
                "sparkpilot.mil/description": (
...
def _istio_authorization_policy_allow(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "sparkpilot.mil/generated": datetime.now(timezone.utc).isoformat(),
                "sparkpilot.mil/description": "Allow-list for intra-namespace and monitoring traffic",
            },
        },
        "spec": {
            "action": "ALLOW",
...
def _istio_virtual_service(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "sparkpilot.mil/generated": datetime.now(timezone.utc).isoformat(),
                "sparkpilot.mil/description": "Traffic routing with retries and timeouts",
            },
        },
        "spec": {
            "hosts": [project_name],
...
def _istio_sidecar(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "sparkpilot.mil/generated": datetime.now(timezone.utc).isoformat(),
                "sparkpilot.mil/description": "Egress traffic restriction via Sidecar CRD",
            },
        },
        "spec": {
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "sparkpilot.mil/generated": datetime.now(timezone.utc).isoformat(),
                "sparkpilot.mil/adr": "D121",
                "sparkpilot.mil/description": "mTLS Server policy for project workloads",
            },
        },
        "spec": {
            "podSelector": {
...
def _linkerd_service_profile(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "sparkpilot.mil/generated": datetime.now(timezone.utc).isoformat(),
                "sparkpilot.mil/description": "Retries and timeouts via Linkerd ServiceProfile",
            },
        },
        "spec": {
            "routes": [
...
def _linkerd_http_route(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "sparkpilot.mil/generated": datetime.now(timezone.utc).isoformat(),
                "sparkpilot.mil/description": "Linkerd HTTPRoute — traffic routing with timeout/retry",
...
def generate_istio_config(project_id: str, profile: dict = None) -> dict:
    ...
    All manifests carry sparkpilot.mil/* labels and classification annotations.
    PDP references are surfaced as annotations only (ADR D124).

    Args:
        project_id: SPARKPILOT project identifier.
...
def _human_output(result: dict) -> None:
    ...
    print(f"\n{'='*60}")
    print(f"  SPARKPILOT Service Mesh Generator — {mesh}")
    print(f"{'='*60}")
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate Istio or Linkerd service mesh configurations for an SPARKPILOT project.",
...
""",
    ...
    parser.add_argument(
        ...
        required=True,
        metavar="PROJECT_ID",
        help="SPARKPILOT project identifier",
    )
    parser.add_argument(
        "--mesh",
