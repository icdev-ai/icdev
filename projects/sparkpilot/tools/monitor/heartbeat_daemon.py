...
Polls on a configurable interval and runs 7 check functions against the SPARKPILOT
...
def check_memory_maintenance(
    ...
    if db_path and db_path != DB_PATH:
        # Allow overriding for tests; assume memory.db lives next to sparkpilot.db
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="SPARKPILOT Heartbeat Daemon (D141) — proactive check loop"
    )
