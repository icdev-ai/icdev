# [TEMPLATE: CUI // SP-CTI]
# SPARKPILOT Agent Executor — Claude Code CLI subprocess invocation
...
Usage:
    ...
    request = AgentTemplateRequest(
        agent_name="planner",
        slash_command="/sparkpilot-build",
...
SLASH_COMMAND_MODEL_MAP = {
    ...
    "/sparkpilot-init": "sonnet",
    "/sparkpilot-build": "opus",
    "/sparkpilot-comply": "sonnet",
    "/sparkpilot-deploy": "sonnet",
    "/bug": "opus",
    "/feature": "opus",
    "/chore": "sonnet",
    "/patch": "sonnet",
    # Testing (fast execution)
    "/sparkpilot-test": "sonnet",
    "/test": "sonnet",
    "/test_e2e": "sonnet",
    "/resolve_failed_test": "sonnet",
    "/resolve_failed_e2e_test": "sonnet",
    # Review/security (needs depth)
    "/sparkpilot-review": "opus",
    "/review": "opus",
    "/sparkpilot-secure": "sonnet",
    "/sparkpilot-status": "haiku",
    "/sparkpilot-monitor": "sonnet",
    "/sparkpilot-knowledge": "sonnet",
    # Documentation
    "/document": "sonnet",
    # Git operations (fast)
    "/commit": "haiku",
