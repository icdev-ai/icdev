# [TEMPLATE: CUI // SP-CTI]
# SPARKPILOT Comment Handler — cross-platform comment/message posting (D132, D136)
...
that triggered the workflow. All responses include [SPARKPILOT-BOT] identifier
for loop prevention.
