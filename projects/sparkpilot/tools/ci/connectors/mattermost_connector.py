# [TEMPLATE: CUI // SP-CTI]
# SPARKPILOT Mattermost Connector — built-in Mattermost integration (D136, D137)

"""
Built-in Mattermost connector for SPARKPILOT CI/CD.
...
Uses only `requests` (existing SPARKPILOT dependency) + stdlib `hmac`/`hashlib`.
