# [TEMPLATE: CUI // SP-CTI]
# SPARKPILOT Plan — Agentic planning workflow
# Adapted from ADW adw_plan.py with dual platform support

"""
SPARKPILOT Plan — Issue classification, branch creation, and plan generation.
...
def main():
    ...
    logger.info(f"SPARKPILOT Plan starting — run_id: {run_id}, issue: #{issue_number}")
