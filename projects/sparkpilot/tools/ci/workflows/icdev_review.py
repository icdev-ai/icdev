# [TEMPLATE: CUI // SP-CTI]
# SPARKPILOT Review — Code review workflow
# Adapted from ADW adw_review.py with dual platform support

"""
SPARKPILOT Review — Automated code review against spec with security checks.
...
def run_review(plan_file: str, run_id: str, logger: logging.Logger) -> dict:
    ...
    request = AgentTemplateRequest(
        ...
        slash_command="/sparkpilot-review",
        args=[plan_file],
        run_id=run_id,
    )
...
def main():
    ...
    logger.info(f"SPARKPILOT Review starting — run_id: {run_id}, issue: #{issue_number}")
