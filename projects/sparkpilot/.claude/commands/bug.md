...
7. **Post Plan to GitHub Issue**:
   ```bash
   gh issue comment <number> --body "[sparkpilot-BOT] Fix plan created: specs/<filename>.md
...
46. **Post Completion to GitHub Issue** — Include actual results from each gate:
    ```bash
    gh issue comment <number> --body "[sparkpilot-BOT] Bug fix complete — all sparkpilot DevSecOps gates passed.
...
## Report
- Summarize what was done: issue created, branch created, plan written, fix implemented, all sparkpilot DevSecOps gates passed.
