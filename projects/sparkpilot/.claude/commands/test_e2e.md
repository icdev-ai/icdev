...
- Use the `application_url` (default: http://localhost:5000 for sparkpilot dashboard)
...
Ensure the sparkpilot dashboard or target application is running before executing tests.
