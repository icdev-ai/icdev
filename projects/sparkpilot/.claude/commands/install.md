# Install — Full sparkpilot Setup with All Compliance Frameworks

Complete first-time setup of the sparkpilot platform with all compliance frameworks enabled for testing.
