# sparkpilot Application Validation Test Suite

Execute comprehensive validation tests for sparkpilot-built projects, returning results in standardized JSON format for automated processing.
