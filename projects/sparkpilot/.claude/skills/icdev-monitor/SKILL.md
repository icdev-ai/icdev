...
# /icdev-monitor — Monitoring & Self-Healing

## Usage
```
/icdev-monitor [<project-id>] [--check health|logs|metrics|alerts|all] [--self-heal] [--since 1h|6h|24h|7d]
```
...
Use the `self_heal` MCP tool from icdev-knowledge:
