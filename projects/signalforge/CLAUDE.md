...
This file provides guidance to Claude Code (claude.ai/code) when working with signalforge.
...
### Compliance Commands
```bash
python tools/compliance/ssp_generator.py --project-id "signalforge"
python tools/compliance/poam_generator.py --project-id "signalforge"
python tools/compliance/stig_checker.py --project-id "signalforge"
...
python tools/compliance/control_mapper.py --activity "code.commit" --project-id "signalforge"
python tools/compliance/crosswalk_engine.py --control AC-2
python tools/compliance/crosswalk_engine.py --project-id "signalforge" --coverage
python tools/compliance/fedramp_assessor.py --project-id "signalforge" --baseline moderate
python tools/compliance/cmmc_assessor.py --project-id "signalforge" --level 2
python tools/compliance/oscal_generator.py --project-id "signalforge" --artifact ssp
...
python tools/security/container_scanner.py --image "signalforge:latest"
```
...
python tools/security/ai_bom_generator.py --project-id "signalforge" --project-dir . --json
python tools/compliance/atlas_assessor.py --project-id "signalforge" --json
python tools/compliance/owasp_llm_assessor.py --project-id "signalforge" --json
python tools/compliance/owasp_agentic_assessor.py --project-id "signalforge" --json
python tools/security/agent_trust_scorer.py --all --json
```

### Requirements Intake (RICOAS) Commands
```bash
python tools/requirements/intake_engine.py --project-id "signalforge" --customer-name "Name" --customer-org "Org" --impact-level IL4 --json
...
python tools/requirements/boundary_analyzer.py --project-id "signalforge" --list-assessments --json
python tools/supply_chain/dependency_graph.py --project-id "signalforge" --build-graph --json
python tools/supply_chain/scrm_assessor.py --project-id "signalforge" --aggregate --json
python tools/supply_chain/cve_triager.py --project-id "signalforge" --sla-check --json
python tools/simulation/simulation_engine.py --project-id "signalforge" --create-scenario --scenario-name "Scenario" --scenario-type what_if --json
...
```bash
python tools/devsecops/profile_manager.py --project-id "signalforge" --assess --json
python tools/devsecops/pipeline_security_generator.py --project-id "signalforge" --json
python tools/devsecops/policy_generator.py --project-id "signalforge" --engine kyverno --json
python tools/devsecops/zta_maturity_scorer.py --project-id "signalforge" --all --json
python tools/compliance/nist_800_207_assessor.py --project-id "signalforge" --json
python tools/devsecops/service_mesh_generator.py --project-id "signalforge" --mesh istio --json
```

### Observability & XAI Commands
```bash
python tools/observability/shap/agent_shap.py --project-id "signalforge" --last-n 10 --json
python tools/observability/provenance/prov_query.py --entity-id "<id>" --direction backward --json
python tools/observability/provenance/prov_export.py --project-id "signalforge" --json
python tools/compliance/xai_assessor.py --project-id "signalforge" --json
```
...
| Database | Purpose |
|----------|---------|
| `data/signalforge.db` | Main operational DB: projects, agents, audit trail, compliance, RICOAS, AI security, observability, DevSecOps/ZTA, code intelligence |
