...
### 3. Generate SSP
Use the `ssp_generate` MCP tool from icdev-compliance:
...
### 5. Generate POAM
Use the `poam_generate` MCP tool from icdev-compliance:
- project_id: from arguments
...
Use the `cssp_ir_plan` MCP tool from icdev-compliance:
- project_id: from arguments
...
Use the `cssp_evidence` MCP tool from icdev-compliance:
- project_id: from arguments
...
Use the `cssp_report` MCP tool from icdev-compliance:
- project_id: from arguments
...
Use the `xacta_sync` MCP tool from icdev-compliance:
- project_id: from arguments
...
Use the `sbd_assess` MCP tool from icdev-compliance:
- project_id: from arguments
...
Use the `sbd_report` MCP tool from icdev-compliance:
- project_id: from arguments
...
Use the `rtm_generate` MCP tool from icdev-compliance:
- project_id: from arguments
- project_dir: project's source directory
...
Use the `ivv_assess` MCP tool from icdev-compliance:
- project_id: from arguments
...
Use the `ivv_report` MCP tool from icdev-compliance:
- project_id: from arguments
