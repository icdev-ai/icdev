# Install — Full signalforge Setup with All Compliance Frameworks

Complete first-time setup of the signalforge platform with all compliance frameworks enabled for testing.
