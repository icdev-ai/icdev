...
- Use the `application_url` (default: http://localhost:5000 for signalforge dashboard)
...
Ensure the signalforge dashboard or target application is running before executing tests.
