# signalforge Application Validation Test Suite

Execute comprehensive validation tests for signalforge-built projects, returning results in standardized JSON format for automated processing.
