...
## Purpose
Bridge the vocabulary gap between SIGNALFORGE's technical AI capabilities (XAI, SHAP, telemetry)
...
## Trigger
- User runs `/signalforge-transparency`
...
- **D309**: System cards are SIGNALFORGE-specific — broader than model cards
...
- **D313**: GAO evidence builder — reuses existing SIGNALFORGE data, no new collection
