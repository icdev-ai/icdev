# [TEMPLATE: CUI // SP-CTI]
# SIGNALFORGE Testing Utilities
# Adapted from ADW utils.py for Gov/DoD testing workflows

"""Utility functions for SIGNALFORGE testing framework.
...
def setup_logger(run_id: str, phase: str = "test_run") -> logging.Logger:
    ...
    logger.info(f"SIGNALFORGE Test Logger initialized - Run: {run_id}, Phase: {phase}")
...
def get_safe_subprocess_env() -> Dict[str, str]:
    ...
    Adapted from ADW get_safe_subprocess_env with SIGNALFORGE-specific variables.
    ...
    safe_env_vars = {
        ...
        "ICDEV_DB_PATH": os.getenv("ICDEV_DB_PATH", str(PROJECT_ROOT / "data" / "signalforge.db")),
