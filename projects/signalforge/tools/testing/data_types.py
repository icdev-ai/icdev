# [TEMPLATE: CUI // SP-CTI]
# SIGNALFORGE Testing Data Types
# Adapted from ADW data_types.py for Gov/DoD testing workflows

"""Pydantic data models for SIGNALFORGE testing framework.
...
class HealthCheckResult(BaseModel):
    """Aggregate health check results for the SIGNALFORGE system."""
    success: bool
    timestamp: str
...
# --- Compliance Gate Types (SIGNALFORGE-specific) ---
...
class GateEvaluation(BaseModel):
    ...
    evaluated_by: str = "signalforge-testing"
...
class AgentTemplateRequest(BaseModel):
    ...
    agent_name: str
    slash_command: str  # e.g., "/signalforge-test", "/signalforge-secure"
    args: List[str] = []
    run_id: str = ""
    model: Literal["sonnet", "opus", "haiku"] = "sonnet"
