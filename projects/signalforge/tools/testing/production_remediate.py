...
DB_PATH = PROJECT_ROOT / "data" / "signalforge.db"
...
REMEDIATION_REGISTRY: Dict[str, dict] = {
    ...
    "SEC-002": {
        ...
        "command": [
            ...
            "--project-id", "signalforge-platform", "--auto", "--json",
        ],
        "suggestion": None,
    },
    "INT-002": {
    ...
    "AI-001": {
        ...
        "command": [
            ...
            "--project-id", "signalforge-platform", "--register", "--name", "default", "--json",
        ],
        "suggestion": None,
    },
    "AI-002": {
        ...
        "command": [
            ...
            "--project-id", "signalforge-platform", "--model-name", "default", "--json",
        ],
        "suggestion": None,
    },
    "AI-003": {
        ...
        "command": [
            ...
            "--project-id", "signalforge-platform", "--json",
        ],
        "suggestion": None,
    },
...
def run_remediation(
    ...
    if stream:
        print("\n" + "=" * 60, file=sys.stderr)
        print("  SIGNALFORGE Production Remediation", file=sys.stderr)
...
def _format_human(report: RemediationReport) -> str:
    ...
    lines.append("")
    lines.append("=" * 60)
    lines.append("  SIGNALFORGE Production Remediation Report")
    lines.append("=" * 60)
    lines.append("")
...
def main():
    parser = argparse.ArgumentParser(
        description="SIGNALFORGE Production Remediation — auto-fix audit blockers"
    )
