#!/usr/bin/env python3
# CUI // SP-CTI
"""SIGNALFORGE Platform Compatibility Checker.

Validates that the current OS environment can run SIGNALFORGE tools.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="SIGNALFORGE platform compatibility check")
    ...
    if args.json:
        ...
        print(f"SIGNALFORGE Platform Check -- {PLATFORM_NAME}")
        print("=" * 50)
        for r in results:
