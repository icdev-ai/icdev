# [TEMPLATE: CUI // SP-CTI]
# SIGNALFORGE Dashboard UX Helpers
# Server-side utilities for user-friendly display
"""
UX Helpers for the SIGNALFORGE Dashboard
===================================
Provides server-side utilities that make the SIGNALFORGE dashboard intuitive for
...
ERROR_RECOVERY = {
    ...
    "database_not_initialized": {
        "what": "The SIGNALFORGE database has not been set up yet",
        "why": (
            "SIGNALFORGE needs its database to track projects, compliance, "
            "and audit trails"
        ),
        "fix": (
            "Run this command:\n"
