...
Usage:
    ...
    tracer = OTelTracer(service_name="signalforge-builder", endpoint="http://localhost:4317")
...
logger = logging.getLogger("signalforge.observability.otel_tracer")
...
class OTelTracer(Tracer):
    ...
    def __init__(
        ...
        self._tracer = otel_trace.get_tracer("signalforge.observability", "0.1.0")
