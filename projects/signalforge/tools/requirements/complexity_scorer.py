...
appropriate pipeline depth:
  ...
  - **Standard**: Moderate complexity, standard SIGNALFORGE pipeline
...
def _build_recommendation(overall_score: float, complexity_level: str) -> dict:
    ...
    if complexity_level == "quick_flow":
        ...
        return {
            ...
            "estimated_phases": 3,
            "rationale": (
                "Moderate complexity project. Standard SIGNALFORGE pipeline recommended: "
...
def score_complexity(session_id: str, db_path=None) -> dict:
    ...
    Args:
        ...
        db_path: Optional Path override for the SIGNALFORGE database.
...
def main():
    parser = argparse.ArgumentParser(
        description="SIGNALFORGE Scale-Adaptive Complexity Scorer (BMAD pattern)"
    )
