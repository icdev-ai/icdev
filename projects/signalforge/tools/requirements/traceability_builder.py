...
def build_rtm(project_id, session_id=None, db_path=None):
    ...
    try:
            ...
            if existing:
                ...
                conn.execute(
                    ...
                    (project_id, req_session_id, req_id, "intake",
                     ...
                     coverage,
                     json.dumps(missing) if missing else None,
                     now, "signalforge-traceability-builder",
                     now, now),
                )
        ...
        log_event(
            ...
            actor="signalforge-traceability-builder",
...
def main():
    parser = argparse.ArgumentParser(
        description="Requirements Traceability Matrix builder for SIGNALFORGE RICOAS"
    )
    parser.add_argument("--project-id", required=True, help="SIGNALFORGE project ID")
