...
def catalog_lookup(control_id, catalog_source="auto", catalog_path=None):
    ...
    Args:
        ...
        catalog_source: "auto" (official first), "official", or "signalforge".
    ...
    if catalog_path:
        ...
        elif catalog_source == "signalforge":
...
def catalog_list(family=None, catalog_source="auto", catalog_path=None):
    ...
    Args:
        ...
        catalog_source: "auto", "official", or "signalforge".
        catalog_path: Direct path to a catalog file (overrides catalog_source).
...
def main():
    ...
    parser.add_argument("--catalog-source", choices=["auto", "official", "signalforge"],
