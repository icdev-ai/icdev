#!/usr/bin/env python3
# CUI // SP-CTI
"""Parse and validate signalforge.yaml project manifests.

Reads signalforge.yaml from a project directory, validates structure and
...
Usage:
    ...
    python tools/project/manifest_loader.py --file /path/to/signalforge.yaml --validate
"""
...
MANIFEST_FILENAME = "signalforge.yaml"
MANIFEST_VERSION = 1
...
def load_manifest(directory: str = None, file_path: str = None) -> dict:
    """Load and parse signalforge.yaml from a directory or explicit path.

    Args:
        directory: Directory containing signalforge.yaml (defaults to cwd).
        file_path: Explicit path to an signalforge.yaml file (overrides directory).
...
def main():
    parser = argparse.ArgumentParser(
        description="Parse and validate signalforge.yaml project manifests"
    )
    parser.add_argument("--dir", help="Project directory containing signalforge.yaml")
    parser.add_argument("--file", help="Explicit path to signalforge.yaml")
