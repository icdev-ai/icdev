...
def scaffold_python_webapp(project_dir: Path, project_name: str, classification: str) -> list:
    ...
    write_file(
        ...
        f'"""SIGNALFORGE Project: {project_name}"""\n\n__version__ = "0.1.0"\n',
        classification,
    )
...
name = "{slug}"
version = "0.1.0"
description = "{project_name} - SIGNALFORGE managed project"
...
LABEL maintainer="SIGNALFORGE System"
...
compliance-check:
  ...
  image: python:3.11-slim
  script:
    - echo "Compliance checks run by SIGNALFORGE compliance engine"
...
name = "{slug}"
version = "0.1.0"
description = "{project_name} microservice - SIGNALFORGE managed"
requires-python = ">=3.11"
dependencies = [
    "fastapi>=0.104",
...
def cli():
    """{project_name} - SIGNALFORGE managed CLI tool."""
    pass
...
name = "{slug}"
version = "0.1.0"
description = "{project_name} CLI tool - SIGNALFORGE managed"
requires-python = ">=3.11"
dependencies = [
    "click>=8.1",
    "rich>=13.0",
...
name = "{slug}"
version = "0.1.0"
description = "{project_name} data pipeline - SIGNALFORGE managed"
requires-python = ">=3.11"
dependencies = [
    "pandas>=2.1",
    "sqlalchemy>=2.0",
...
def scaffold_js_frontend(project_dir: Path, project_name: str, classification: str) -> list:
    ...
    package_json = {
        ...
        "version": "0.1.0",
        "private": True,
        "description": f"{project_name} - SIGNALFORGE managed frontend",
        "scripts": {
            "dev": "vite",
