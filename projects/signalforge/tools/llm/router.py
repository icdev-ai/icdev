...
Reads args/llm_config.yaml and resolves each SIGNALFORGE function to a
...
logger = logging.getLogger("signalforge.llm.router")
...
class LLMRouter:
    """Config-driven router that maps SIGNALFORGE functions to LLM providers.
    ...
    def invoke(self, function: str, request: LLMRequest) -> LLMResponse:
        ...
        Args:
            function: SIGNALFORGE function name (e.g. 'code_generation', 'nlq_sql').
        ...
        for model_name in chain:
            ...
            if tracer:
                span = tracer.start_span("gen_ai.invoke", kind="CLIENT", attributes={
                    ...
                    "signalforge.llm_function": function,
                })
