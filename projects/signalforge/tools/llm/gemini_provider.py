...
logger = logging.getLogger("signalforge.llm.gemini")
...
def _convert_messages_to_gemini(
    ...
    """Convert SIGNALFORGE universal messages to Gemini content format.
...
def _convert_tools_to_gemini(tools: List[Dict]) -> List[Any]:
    """Convert SIGNALFORGE/OpenAI tool format to Gemini function declarations.
