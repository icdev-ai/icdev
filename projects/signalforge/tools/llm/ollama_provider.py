...
(used internally by SIGNALFORGE's LLMRequest) and converts it to Ollama's
...
logger = logging.getLogger("signalforge.llm.ollama")
...
def _convert_messages_to_ollama(messages: List[Dict[str, Any]],
    ...
    """Convert SIGNALFORGE universal messages to Ollama native chat format.
