...
def generate_python(project_path: str, config: dict = None) -> list:
    ...
    project_name = config.get("project_name", "signalforge-app")
...
def main():
    ...
    parser.add_argument("--project-name", default="signalforge-app", help="Project name for labels")
