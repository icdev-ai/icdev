...
# Generated: {timestamp}
# Generator: SIGNALFORGE Iron Bank Metadata Generator (D350)
apiVersion: v1
name: "{project_name}"
tags:
  - "{project_name}:latest"
...
image_author:
  name: "SIGNALFORGE Auto-Generator"
  email: "signalforge@{project_slug}.mil"
...
vulnerability_report:
  - url: "{vuln_scan_url}"
    description: "SBOM and vulnerability scan — generated by SIGNALFORGE sbom_generator.py"
...
def generate_hardening_manifest(
    ...
    Args:
        ...
        db_path: Path to SIGNALFORGE database (optional).
    ...
    description = "SIGNALFORGE-generated hardened container"
    impact_level = "IL4"
    classification = "CUI"
    version = "1.0.0"
