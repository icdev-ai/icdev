...
resource "kubernetes_namespace" "main" {
  metadata {
    name = var.namespace
    labels = {
      "app.kubernetes.io/managed-by" = "signalforge-terraform"
      "signalforge/classification"          = var.classification
      "signalforge/environment"             = var.environment
    }
  }
}
...
# PostgreSQL database for SIGNALFORGE
resource "postgresql_database" "signalforge" {
...
output "database_name" {
  ...
  value       = postgresql_database.signalforge.name
}
"""
...
resource "docker_network" "signalforge" {
...
def generate(project_name: str = "signalforge", environment: str = "production",
...
def run_cli():
    ...
    parser.add_argument("--project-id", default="signalforge", help="Project name")
