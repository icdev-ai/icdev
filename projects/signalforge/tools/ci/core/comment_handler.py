# [TEMPLATE: CUI // SP-CTI]
# SIGNALFORGE Comment Handler — cross-platform comment/message posting (D132, D136)
...
that triggered the workflow. All responses include [SIGNALFORGE-BOT] identifier
for loop prevention.
