# [TEMPLATE: CUI // SP-CTI]
# SIGNALFORGE Mattermost Connector — built-in Mattermost integration (D136, D137)

"""
Built-in Mattermost connector for SIGNALFORGE CI/CD.
...
Uses only `requests` (existing SIGNALFORGE dependency) + stdlib `hmac`/`hashlib`.
