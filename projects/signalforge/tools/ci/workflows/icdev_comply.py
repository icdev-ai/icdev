# [TEMPLATE: CUI // SP-CTI]
# SIGNALFORGE Comply — Compliance artifact generation workflow
# Runs SSP, POAM, STIG, SBOM, CUI marker and evaluates compliance gate

"""
SIGNALFORGE Comply — Generate ATO compliance artifacts.
...
def _run_agent_comply(run_id: str, artifact_type: str, logger: logging.Logger):
    ...
    try:
        ...
        request = AgentTemplateRequest(
            ...
            slash_command="/signalforge-comply",
            args=[artifact_type],
            run_id=run_id,
        )
...
def main():
    ...
    print("CUI // SP-CTI")
    print(f"SIGNALFORGE Comply — run_id: {run_id}, issue: #{issue_number}")
