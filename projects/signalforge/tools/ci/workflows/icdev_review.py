# [TEMPLATE: CUI // SP-CTI]
# SIGNALFORGE Review — Code review workflow
# Adapted from ADW adw_review.py with dual platform support

"""
SIGNALFORGE Review — Automated code review against spec with security checks.
...
def run_review(plan_file: str, run_id: str, logger: logging.Logger) -> dict:
    ...
    request = AgentTemplateRequest(
        ...
        slash_command="/signalforge-review",
        args=[plan_file],
        run_id=run_id,
    )
...
def main():
    ...
    logger.info(f"SIGNALFORGE Review starting — run_id: {run_id}, issue: #{issue_number}")
