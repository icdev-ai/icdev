# [TEMPLATE: CUI // SP-CTI]
# SIGNALFORGE SDLC — Complete Software Development Life Cycle orchestrator
# Adapted from ADW adw_sdlc.py with dual platform support

"""
SIGNALFORGE SDLC — Chains together all workflow phases.
...
def main():
    ...
    print(f"\n{'='*60}")
    print("  SIGNALFORGE SDLC COMPLETE")
    print(f"{'='*60}")
    print(f"Run ID: {run_id}")
    print(f"Issue:  #{issue_number}")
