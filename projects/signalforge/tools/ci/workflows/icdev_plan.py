# [TEMPLATE: CUI // SP-CTI]
# SIGNALFORGE Plan — Agentic planning workflow
# Adapted from ADW adw_plan.py with dual platform support

"""
SIGNALFORGE Plan — Issue classification, branch creation, and plan generation.
...
def main():
    ...
    logger.info(f"SIGNALFORGE Plan starting — run_id: {run_id}, issue: #{issue_number}")
