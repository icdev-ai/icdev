# [TEMPLATE: CUI // SP-CTI]
# SIGNALFORGE Agent Executor — Claude Code CLI subprocess invocation
...
Usage:
    ...
    request = AgentTemplateRequest(
        agent_name="planner",
        slash_command="/signalforge-build",
...
SLASH_COMMAND_MODEL_MAP = {
    ...
    "/signalforge-init": "sonnet",
    "/signalforge-build": "opus",
    "/signalforge-comply": "sonnet",
    "/signalforge-deploy": "sonnet",
    "/bug": "opus",
    "/feature": "opus",
    "/chore": "sonnet",
    "/patch": "sonnet",
    # Testing (fast execution)
    "/signalforge-test": "sonnet",
    "/test": "sonnet",
    "/test_e2e": "sonnet",
    "/resolve_failed_test": "sonnet",
    "/resolve_failed_e2e_test": "sonnet",
    # Review/security (needs depth)
    "/signalforge-review": "opus",
    "/review": "opus",
    "/signalforge-secure": "sonnet",
    "/signalforge-status": "haiku",
    "/signalforge-monitor": "sonnet",
    "/signalforge-knowledge": "sonnet",
    # Documentation
    "/document": "sonnet",
    # Git operations (fast)
    "/commit": "haiku",
...
BOT_IDENTIFIER = "[SIGNALFORGE-BOT]"
