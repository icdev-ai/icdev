...
Polls on a configurable interval and runs 7 check functions against the SIGNALFORGE
...
def check_memory_maintenance(
    ...
    if db_path and db_path != DB_PATH:
        # Allow overriding for tests; assume memory.db lives next to signalforge.db
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="SIGNALFORGE Heartbeat Daemon (D141) — proactive check loop"
    )
