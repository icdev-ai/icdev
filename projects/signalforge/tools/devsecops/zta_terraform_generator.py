...
# Generator: SIGNALFORGE DevSecOps/ZTA Agent
...
def _zta_file_header(module_name: str) -> str:
    ...
    return (
        ...
        f"# Generated by SIGNALFORGE DevSecOps/ZTA Agent\n"
        f"# Region: {REGION}\n"
...
def _guardduty_hcl(header: str, config: dict) -> str:
    project_name = config.get("project_name", "signalforge")
...
def main():
    ...
    parser.add_argument("--project-name", default="signalforge", help="Project name for resource naming")
    parser.add_argument(
        "--environment",
        default="dev",
