                    ...
                    "pattern": {
                        "metadata": {
                            "labels": {
                                ...
                                "signalforge.mil/classification": f"{classification}",
                            }
                        }
                    },
                },
            ...
            "rules": [{
                ...
                "validate": {
                    ...
                    "deny": {
                        "conditions": {
                            "any": [{
                                "key": "{{request.object.metadata.labels.\"signalforge.mil/network-policy\"}}",
                                "operator": "Equals",
                                "value": "",
                            }]
                        }
        ...
        config = {
            ...
            "metadata": {
                ...
                "labels": {
                    ...
                    "signalforge.mil/component": "devsecops-policy-engine",
                },
            },
        }
        return {
