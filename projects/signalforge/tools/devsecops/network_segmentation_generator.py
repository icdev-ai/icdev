...
_CUI_HEADER = (
    ...
    "# Generated: {timestamp}\n"
    "# Generator: SIGNALFORGE Network Segmentation Generator\n"
...
_ZTA_LABELS = {
    "signalforge.mil/component": "zta-network-segmentation",
    "signalforge.mil/classification": "CUI",
...
def _get_db():
    """Open connection to SIGNALFORGE SQLite database."""
        ...
        deny_ingress = {
            ...
            "metadata": {
                ...
                "labels": _zta_labels({
                    ...
                    "signalforge.mil/namespace": ns,
                }),
                "annotations": {
                    "signalforge.mil/classification": "CUI",
                    "signalforge.mil/generated": datetime.now(timezone.utc).isoformat(),
                    "signalforge.mil/nist-controls": "AC-3,AC-4,SC-7",
                    "signalforge.mil/purpose": "ZTA default-deny ingress — blocks all inbound traffic",
                },
            },
            "spec": {
                "podSelector": {},
        ...
        deny_egress = {
            ...
            "metadata": {
                ...
                "annotations": {
                    "signalforge.mil/classification": "CUI",
                    "signalforge.mil/generated": datetime.now(timezone.utc).isoformat(),
                    "signalforge.mil/nist-controls": "AC-3,AC-4,SC-7,SC-8",
                    "signalforge.mil/purpose": "ZTA default-deny egress — DNS-only exception to kube-system",
                },
            },
            "spec": {
                "podSelector": {},
        ...
        netpol = {
            ...
            "metadata": {
                ...
                "labels": _zta_labels({
                    ...
                    "signalforge.mil/service": svc_name,
                }),
                "annotations": {
                    "signalforge.mil/classification": "CUI",
                    "signalforge.mil/generated": datetime.now(timezone.utc).isoformat(),
                    "signalforge.mil/nist-controls": "AC-3,AC-4,SC-7,SC-8,SC-13",
                    "signalforge.mil/purpose": (
                        f"ZTA micro-segmentation for {svc_name} — "
                        f"port-level ingress/egress restricted to port {svc_port}"
                    ),
                    "signalforge.mil/zta-maturity": "optimal",
                },
            },
            "spec": {
                "podSelector": {
...
def main():
    ...
    if use_json:
        ...
        print("=" * 70)
        print("SIGNALFORGE Network Segmentation Generator — ZTA Micro-Segmentation")
