...
# CUI Category: CTI
# Distribution: D
# POC: SIGNALFORGE System Administrator
"""Service Mesh Configuration Generator for SIGNALFORGE.
...
the ZTA profile. PDP is modeled as an external reference — SIGNALFORGE generates
...
ADR D124: PDP modeled as external reference; SIGNALFORGE generates PEP configs only.
"""
...
def _get_db():
    """Get an SIGNALFORGE database connection with WAL mode and Row factory."""
...
def _mesh_labels(project_id: str, component: str, classification: str = "CUI") -> dict:
    """Return standard SIGNALFORGE service mesh labels for a K8s resource."""
    return {
        "signalforge.mil/project": project_id,
        "signalforge.mil/component": component,
        "signalforge.mil/classification": classification,
...
def _istio_peer_authentication(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "signalforge.mil/generated": datetime.now(timezone.utc).isoformat(),
                "signalforge.mil/adr": "D121",
                "signalforge.mil/description": "Namespace-wide STRICT mTLS enforcement",
            },
        },
        "spec": {
...
def _istio_authorization_policy(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "signalforge.mil/generated": datetime.now(timezone.utc).isoformat(),
                "signalforge.mil/adr": "D124",
                "signalforge.mil/pdp-references": pdp_annotation,
                "signalforge.mil/description": (
...
def _istio_authorization_policy_allow(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "signalforge.mil/generated": datetime.now(timezone.utc).isoformat(),
                "signalforge.mil/description": "Allow-list for intra-namespace and monitoring traffic",
            },
        },
        "spec": {
            "action": "ALLOW",
...
def _istio_virtual_service(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "signalforge.mil/generated": datetime.now(timezone.utc).isoformat(),
                "signalforge.mil/description": "Traffic routing with retries and timeouts",
            },
        },
        "spec": {
            "hosts": [project_name],
...
def _istio_sidecar(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "signalforge.mil/generated": datetime.now(timezone.utc).isoformat(),
                "signalforge.mil/description": "Egress traffic restriction via Sidecar CRD",
            },
        },
        "spec": {
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "signalforge.mil/generated": datetime.now(timezone.utc).isoformat(),
                "signalforge.mil/adr": "D121",
                "signalforge.mil/description": "mTLS Server policy for project workloads",
            },
        },
        "spec": {
            "podSelector": {
...
def _linkerd_service_profile(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "signalforge.mil/generated": datetime.now(timezone.utc).isoformat(),
                "signalforge.mil/description": "Retries and timeouts via Linkerd ServiceProfile",
            },
        },
        "spec": {
            "routes": [
...
def _linkerd_http_route(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "signalforge.mil/generated": datetime.now(timezone.utc).isoformat(),
                "signalforge.mil/description": "Linkerd HTTPRoute — traffic routing with timeout/retry",
...
def generate_istio_config(project_id: str, profile: dict = None) -> dict:
    ...
    All manifests carry signalforge.mil/* labels and classification annotations.
    PDP references are surfaced as annotations only (ADR D124).

    Args:
        project_id: SIGNALFORGE project identifier.
...
def _human_output(result: dict) -> None:
    ...
    print(f"\n{'='*60}")
    print(f"  SIGNALFORGE Service Mesh Generator — {mesh}")
    print(f"{'='*60}")
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate Istio or Linkerd service mesh configurations for an SIGNALFORGE project.",
...
""",
    ...
    parser.add_argument(
        ...
        required=True,
        metavar="PROJECT_ID",
        help="SIGNALFORGE project identifier",
    )
    parser.add_argument(
        "--mesh",
