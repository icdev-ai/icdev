...
"""COA (Course of Action) Generator for the SIGNALFORGE RICOAS Digital Program Twin.
...
Databases:
    - data/signalforge.db: intake_requirements, safe_decomposition,
...
def _create_simulation_for_coa(conn, coa_id, session_id, project_id, coa_type, coa_data):
    ...
    conn.execute(
        ...
        (
            ...
            "completed", "CUI", "signalforge-simulation-engine", now,
        ),
    )
    ...
    try:
        ...
        if _HAS_AUDIT:
            log_event(
                ...
                actor="signalforge-simulation-engine",
