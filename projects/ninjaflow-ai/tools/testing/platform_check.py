#!/usr/bin/env python3
# CUI // SP-CTI
"""NINJAFLOW_AI Platform Compatibility Checker.

Validates that the current OS environment can run NINJAFLOW_AI tools.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="NINJAFLOW_AI platform compatibility check")
    ...
    if args.json:
        ...
        print(f"NINJAFLOW_AI Platform Check -- {PLATFORM_NAME}")
        print("=" * 50)
        for r in results:
