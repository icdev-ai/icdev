...
REMEDIATION_REGISTRY: Dict[str, dict] = {
    ...
    "SEC-002": {
        ...
        "command": [
            ...
            "--project-id", "ninjaflow_ai-platform", "--auto", "--json",
        ],
        "suggestion": None,
    },
    "INT-002": {
    ...
    "AI-001": {
        ...
        "command": [
            ...
            "--project-id", "ninjaflow_ai-platform", "--register", "--name", "default", "--json",
        ],
        "suggestion": None,
    },
    "AI-002": {
        ...
        "command": [
            ...
            "--project-id", "ninjaflow_ai-platform", "--model-name", "default", "--json",
        ],
        "suggestion": None,
    },
    "AI-003": {
        ...
        "command": [
            ...
            "--project-id", "ninjaflow_ai-platform", "--json",
        ],
        "suggestion": None,
    },
...
def run_remediation(
    ...
    if stream:
        print("\n" + "=" * 60, file=sys.stderr)
        print("  NINJAFLOW_AI Production Remediation", file=sys.stderr)
...
def _format_human(report: RemediationReport) -> str:
    ...
    lines.append("")
    lines.append("=" * 60)
    lines.append("  NINJAFLOW_AI Production Remediation Report")
    lines.append("=" * 60)
    lines.append("")
...
def main():
    parser = argparse.ArgumentParser(
        description="NINJAFLOW_AI Production Remediation — auto-fix audit blockers"
    )
