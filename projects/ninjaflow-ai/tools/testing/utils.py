# [TEMPLATE: CUI // SP-CTI]
# NINJAFLOW_AI Testing Utilities
# Adapted from ADW utils.py for Gov/DoD testing workflows

"""Utility functions for NINJAFLOW_AI testing framework.
...
def setup_logger(run_id: str, phase: str = "test_run") -> logging.Logger:
    ...
    logger.info(f"NINJAFLOW_AI Test Logger initialized - Run: {run_id}, Phase: {phase}")
...
def get_safe_subprocess_env() -> Dict[str, str]:
    ...
    Adapted from ADW get_safe_subprocess_env with NINJAFLOW_AI-specific variables.
