# [TEMPLATE: CUI // SP-CTI]
# NINJAFLOW_AI Testing Data Types
# Adapted from ADW data_types.py for Gov/DoD testing workflows

"""Pydantic data models for NINJAFLOW_AI testing framework.
...
class HealthCheckResult(BaseModel):
    """Aggregate health check results for the NINJAFLOW_AI system."""
    success: bool
    timestamp: str
...
# --- Compliance Gate Types (NINJAFLOW_AI-specific) ---
...
class GateEvaluation(BaseModel):
    ...
    evaluated_by: str = "ninjaflow_ai-testing"
...
class AgentTemplateRequest(BaseModel):
    ...
    agent_name: str
    slash_command: str  # e.g., "/ninjaflow_ai-test", "/ninjaflow_ai-secure"
    args: List[str] = []
    run_id: str = ""
    model: Literal["sonnet", "opus", "haiku"] = "sonnet"
