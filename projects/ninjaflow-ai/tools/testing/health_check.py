# [TEMPLATE: CUI // SP-CTI]
# NINJAFLOW_AI System Health Check
# Adapted from ADW health_check.py for Gov/DoD environment validation

"""
NINJAFLOW_AI Health Check — validates the entire NINJAFLOW_AI system is operational.

Usage:
    python tools/testing/health_check.py [--json] [--project-id <id>]

Checks performed:
1. Environment variables (NINJAFLOW_AI, AWS, optional keys)
...
def check_env_vars() -> CheckResult:
    ...
    required_vars = {
        "ICDEV_DB_PATH": "Path to NINJAFLOW_AI database (default: data/icdev.db)",
    }
...
def check_database() -> CheckResult:
    """Check NINJAFLOW_AI database connectivity and table structure."""
...
def check_tools() -> CheckResult:
    """Check that core NINJAFLOW_AI tool modules are importable."""
    tool_modules = {
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="NINJAFLOW_AI System Health Check")
