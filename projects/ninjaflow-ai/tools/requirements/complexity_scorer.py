...
appropriate pipeline depth:
  ...
  - **Standard**: Moderate complexity, standard NINJAFLOW_AI pipeline
...
def _build_recommendation(overall_score: float, complexity_level: str) -> dict:
    ...
    if complexity_level == "quick_flow":
        ...
        return {
            ...
            "estimated_phases": 3,
            "rationale": (
                "Moderate complexity project. Standard NINJAFLOW_AI pipeline recommended: "
...
def score_complexity(session_id: str, db_path=None) -> dict:
    ...
    Args:
        ...
        db_path: Optional Path override for the NINJAFLOW_AI database.
...
def main():
    parser = argparse.ArgumentParser(
        description="NINJAFLOW_AI Scale-Adaptive Complexity Scorer (BMAD pattern)"
    )
