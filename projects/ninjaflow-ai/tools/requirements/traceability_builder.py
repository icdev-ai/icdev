...
def build_rtm(project_id, session_id=None, db_path=None):
    ...
    try:
            ...
            if existing:
                ...
                conn.execute(
                    ...
                    (project_id, req_session_id, req_id, "intake",
                     ...
                     coverage,
                     json.dumps(missing) if missing else None,
                     now, "ninjaflow_ai-traceability-builder",
                     now, now),
                )
        ...
        log_event(
            ...
            actor="ninjaflow_ai-traceability-builder",
...
def main():
    parser = argparse.ArgumentParser(
        description="Requirements Traceability Matrix builder for NINJAFLOW_AI RICOAS"
    )
    parser.add_argument("--project-id", required=True, help="NINJAFLOW_AI project ID")
