...
def score_ai_governance_readiness(project_id: str, conn: sqlite3.Connection = None,
    ...
    if components["inventory_registered"] == 0.0:
        gaps.append({
            ...
            "remediation": "Register AI systems via /ninjaflow_ai-transparency inventory",
        })
    ...
    if components["model_cards_present"] == 0.0:
        gaps.append({
            ...
            "remediation": "Create model cards via /ninjaflow_ai-transparency model-card",
        })
    ...
    if components["oversight_plan_exists"] == 0.0:
        gaps.append({
            ...
            "remediation": "Register oversight plan via /ninjaflow_ai-accountability",
        })
    ...
    if components["impact_assessment_done"] == 0.0:
        gaps.append({
            ...
            "remediation": "Run impact assessment via /ninjaflow_ai-accountability",
        })
    ...
    if components["caio_designated"] == 0.0:
        gaps.append({
            ...
            "remediation": "Designate CAIO via /ninjaflow_ai-accountability",
        })
