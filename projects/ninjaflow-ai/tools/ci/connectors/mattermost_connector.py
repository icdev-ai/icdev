# [TEMPLATE: CUI // SP-CTI]
# NINJAFLOW_AI Mattermost Connector — built-in Mattermost integration (D136, D137)

"""
Built-in Mattermost connector for NINJAFLOW_AI CI/CD.
...
Uses only `requests` (existing NINJAFLOW_AI dependency) + stdlib `hmac`/`hashlib`.
