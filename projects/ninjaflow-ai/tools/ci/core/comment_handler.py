# [TEMPLATE: CUI // SP-CTI]
# NINJAFLOW_AI Comment Handler — cross-platform comment/message posting (D132, D136)
...
that triggered the workflow. All responses include [NINJAFLOW-AI-BOT] identifier
for loop prevention.
