# [TEMPLATE: CUI // SP-CTI]
# NINJAFLOW_AI Agent Executor — Claude Code CLI subprocess invocation
...
Usage:
    ...
    request = AgentTemplateRequest(
        agent_name="planner",
        slash_command="/ninjaflow_ai-build",
...
SLASH_COMMAND_MODEL_MAP = {
    ...
    "/ninjaflow_ai-init": "sonnet",
    "/ninjaflow_ai-build": "opus",
    "/ninjaflow_ai-comply": "sonnet",
    "/ninjaflow_ai-deploy": "sonnet",
    "/bug": "opus",
    "/feature": "opus",
    "/chore": "sonnet",
    "/patch": "sonnet",
    # Testing (fast execution)
    "/ninjaflow_ai-test": "sonnet",
    "/test": "sonnet",
    "/test_e2e": "sonnet",
    "/resolve_failed_test": "sonnet",
    "/resolve_failed_e2e_test": "sonnet",
    # Review/security (needs depth)
    "/ninjaflow_ai-review": "opus",
    "/review": "opus",
    "/ninjaflow_ai-secure": "sonnet",
    "/ninjaflow_ai-status": "haiku",
    "/ninjaflow_ai-monitor": "sonnet",
    "/ninjaflow_ai-knowledge": "sonnet",
    # Documentation
    "/document": "sonnet",
    # Git operations (fast)
    "/commit": "haiku",
...
BOT_IDENTIFIER = "[NINJAFLOW-AI-BOT]"
