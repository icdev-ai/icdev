# [TEMPLATE: CUI // SP-CTI]
# NINJAFLOW_AI Workflow State Management
# Adapted from ADW state.py

"""
Persistent state management for NINJAFLOW_AI CI/CD workflows.
...
class ICDevState:
    """Persistent workflow state for NINJAFLOW_AI CI/CD pipelines."""
