# [TEMPLATE: CUI // SP-CTI]
# NINJAFLOW_AI Plan — Agentic planning workflow
# Adapted from ADW adw_plan.py with dual platform support

"""
NINJAFLOW_AI Plan — Issue classification, branch creation, and plan generation.
...
def main():
    ...
    logger.info(f"NINJAFLOW_AI Plan starting — run_id: {run_id}, issue: #{issue_number}")
