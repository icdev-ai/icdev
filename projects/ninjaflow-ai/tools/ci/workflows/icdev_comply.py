# [TEMPLATE: CUI // SP-CTI]
# NINJAFLOW_AI Comply — Compliance artifact generation workflow
# Runs SSP, POAM, STIG, SBOM, CUI marker and evaluates compliance gate

"""
NINJAFLOW_AI Comply — Generate ATO compliance artifacts.
...
def _run_agent_comply(run_id: str, artifact_type: str, logger: logging.Logger):
    ...
    try:
        ...
        request = AgentTemplateRequest(
            ...
            slash_command="/ninjaflow_ai-comply",
            args=[artifact_type],
            run_id=run_id,
        )
...
def main():
    ...
    print("CUI // SP-CTI")
    print(f"NINJAFLOW_AI Comply — run_id: {run_id}, issue: #{issue_number}")
