# [TEMPLATE: CUI // SP-CTI]
# NINJAFLOW_AI Build — Implementation workflow
# Adapted from ADW adw_build.py with dual platform support

"""
NINJAFLOW_AI Build — Implement the plan generated by icdev_plan.
...
def main():
    ...
    logger.info(f"NINJAFLOW_AI Build starting — run_id: {run_id}, issue: #{issue_number}")
