...
logger = logging.getLogger("ninjaflow_ai.llm.gemini")
...
def _convert_messages_to_gemini(
    ...
    """Convert NINJAFLOW_AI universal messages to Gemini content format.
...
def _convert_tools_to_gemini(tools: List[Dict]) -> List[Any]:
    """Convert NINJAFLOW_AI/OpenAI tool format to Gemini function declarations.
