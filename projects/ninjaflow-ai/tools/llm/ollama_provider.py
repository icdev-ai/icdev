...
(used internally by NINJAFLOW_AI's LLMRequest) and converts it to Ollama's
...
logger = logging.getLogger("ninjaflow_ai.llm.ollama")
...
def _convert_messages_to_ollama(messages: List[Dict[str, Any]],
    ...
    """Convert NINJAFLOW_AI universal messages to Ollama native chat format.
