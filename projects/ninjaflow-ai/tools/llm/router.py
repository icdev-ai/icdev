...
Reads args/llm_config.yaml and resolves each NINJAFLOW_AI function to a
...
logger = logging.getLogger("ninjaflow_ai.llm.router")
...
class LLMRouter:
    """Config-driven router that maps NINJAFLOW_AI functions to LLM providers.
    ...
    def invoke(self, function: str, request: LLMRequest) -> LLMResponse:
        ...
        Args:
            function: NINJAFLOW_AI function name (e.g. 'code_generation', 'nlq_sql').
        ...
        for model_name in chain:
            ...
            if tracer:
                span = tracer.start_span("gen_ai.invoke", kind="CLIENT", attributes={
                    ...
                    "ninjaflow_ai.llm_function": function,
                })
