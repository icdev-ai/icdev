...
# Generator: NINJAFLOW_AI DevSecOps/ZTA Agent
...
def _zta_file_header(module_name: str) -> str:
    ...
    return (
        ...
        f"# Generated by NINJAFLOW_AI DevSecOps/ZTA Agent\n"
        f"# Region: {REGION}\n"
...
def _guardduty_hcl(header: str, config: dict) -> str:
    project_name = config.get("project_name", "ninjaflow-ai")
...
def main():
    ...
    parser.add_argument("--project-name", default="ninjaflow-ai", help="Project name for resource naming")
    parser.add_argument(
        "--environment",
        default="dev",
