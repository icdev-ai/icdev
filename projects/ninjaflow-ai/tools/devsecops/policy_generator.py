                    ...
                    "pattern": {
                        "metadata": {
                            "labels": {
                                ...
                                "ninjaflow_ai.mil/classification": f"{classification}",
                            }
                        }
                    },
                },
            ...
            "rules": [{
                ...
                "validate": {
                    ...
                    "deny": {
                        "conditions": {
                            "any": [{
                                "key": "{{request.object.metadata.labels.\"ninjaflow_ai.mil/network-policy\"}}",
                                "operator": "Equals",
                                "value": "",
                            }]
                        }
        ...
        config = {
            ...
            "metadata": {
                ...
                "labels": {
                    ...
                    "ninjaflow_ai.mil/component": "devsecops-policy-engine",
                },
            },
        }
        return {
