...
# CUI Category: CTI
# Distribution: D
# POC: NINJAFLOW_AI System Administrator
"""Service Mesh Configuration Generator for NINJAFLOW_AI.
...
the ZTA profile. PDP is modeled as an external reference — NINJAFLOW_AI generates
...
ADR D124: PDP modeled as external reference; NINJAFLOW_AI generates PEP configs only.
"""
...
def _get_db():
    """Get an NINJAFLOW_AI database connection with WAL mode and Row factory."""
...
def _mesh_labels(project_id: str, component: str, classification: str = "CUI") -> dict:
    """Return standard NINJAFLOW_AI service mesh labels for a K8s resource."""
    return {
        "ninjaflow_ai.mil/project": project_id,
        "ninjaflow_ai.mil/component": component,
        "ninjaflow_ai.mil/classification": classification,
...
def _istio_peer_authentication(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "ninjaflow_ai.mil/generated": datetime.now(timezone.utc).isoformat(),
                "ninjaflow_ai.mil/adr": "D121",
                "ninjaflow_ai.mil/description": "Namespace-wide STRICT mTLS enforcement",
            },
        },
        "spec": {
...
def _istio_authorization_policy(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "ninjaflow_ai.mil/generated": datetime.now(timezone.utc).isoformat(),
                "ninjaflow_ai.mil/adr": "D124",
                "ninjaflow_ai.mil/pdp-references": pdp_annotation,
                "ninjaflow_ai.mil/description": (
...
def _istio_authorization_policy_allow(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "ninjaflow_ai.mil/generated": datetime.now(timezone.utc).isoformat(),
                "ninjaflow_ai.mil/description": "Allow-list for intra-namespace and monitoring traffic",
            },
        },
        "spec": {
            "action": "ALLOW",
...
def _istio_virtual_service(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "ninjaflow_ai.mil/generated": datetime.now(timezone.utc).isoformat(),
                "ninjaflow_ai.mil/description": "Traffic routing with retries and timeouts",
            },
        },
        "spec": {
            "hosts": [project_name],
...
def _istio_sidecar(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "ninjaflow_ai.mil/generated": datetime.now(timezone.utc).isoformat(),
                "ninjaflow_ai.mil/description": "Egress traffic restriction via Sidecar CRD",
            },
        },
        "spec": {
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "ninjaflow_ai.mil/generated": datetime.now(timezone.utc).isoformat(),
                "ninjaflow_ai.mil/adr": "D121",
                "ninjaflow_ai.mil/description": "mTLS Server policy for project workloads",
            },
        },
        "spec": {
            "podSelector": {
...
def _linkerd_service_profile(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "ninjaflow_ai.mil/generated": datetime.now(timezone.utc).isoformat(),
                "ninjaflow_ai.mil/description": "Retries and timeouts via Linkerd ServiceProfile",
            },
        },
        "spec": {
            "routes": [
...
def _linkerd_http_route(
    ...
    return {
        ...
        "metadata": {
            ...
            "annotations": {
                "ninjaflow_ai.mil/generated": datetime.now(timezone.utc).isoformat(),
                "ninjaflow_ai.mil/description": "Linkerd HTTPRoute — traffic routing with timeout/retry",
...
def generate_istio_config(project_id: str, profile: dict = None) -> dict:
    ...
    All manifests carry ninjaflow_ai.mil/* labels and classification annotations.
    PDP references are surfaced as annotations only (ADR D124).

    Args:
        project_id: NINJAFLOW_AI project identifier.
...
def _human_output(result: dict) -> None:
    ...
    print(f"\n{'='*60}")
    print(f"  NINJAFLOW_AI Service Mesh Generator — {mesh}")
    print(f"{'='*60}")
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate Istio or Linkerd service mesh configurations for an NINJAFLOW_AI project.",
...
""",
    ...
    parser.add_argument(
        ...
        required=True,
        metavar="PROJECT_ID",
        help="NINJAFLOW_AI project identifier",
    )
    parser.add_argument(
        "--mesh",
