...
_CUI_HEADER = (
    ...
    "# Generated: {timestamp}\n"
    "# Generator: NINJAFLOW_AI Network Segmentation Generator\n"
...
_ZTA_LABELS = {
    "ninjaflow_ai.mil/component": "zta-network-segmentation",
    "ninjaflow_ai.mil/classification": "CUI",
...
def _get_db():
    """Open connection to NINJAFLOW_AI SQLite database."""
        ...
        deny_ingress = {
            ...
            "metadata": {
                ...
                "labels": _zta_labels({
                    ...
                    "ninjaflow_ai.mil/namespace": ns,
                }),
                "annotations": {
                    "ninjaflow_ai.mil/classification": "CUI",
                    "ninjaflow_ai.mil/generated": datetime.now(timezone.utc).isoformat(),
                    "ninjaflow_ai.mil/nist-controls": "AC-3,AC-4,SC-7",
                    "ninjaflow_ai.mil/purpose": "ZTA default-deny ingress — blocks all inbound traffic",
                },
            },
            "spec": {
                "podSelector": {},
        ...
        deny_egress = {
            ...
            "metadata": {
                ...
                "annotations": {
                    "ninjaflow_ai.mil/classification": "CUI",
                    "ninjaflow_ai.mil/generated": datetime.now(timezone.utc).isoformat(),
                    "ninjaflow_ai.mil/nist-controls": "AC-3,AC-4,SC-7,SC-8",
                    "ninjaflow_ai.mil/purpose": "ZTA default-deny egress — DNS-only exception to kube-system",
                },
            },
            "spec": {
                "podSelector": {},
        ...
        netpol = {
            ...
            "metadata": {
                ...
                "labels": _zta_labels({
                    ...
                    "ninjaflow_ai.mil/service": svc_name,
                }),
                "annotations": {
                    "ninjaflow_ai.mil/classification": "CUI",
                    "ninjaflow_ai.mil/generated": datetime.now(timezone.utc).isoformat(),
                    "ninjaflow_ai.mil/nist-controls": "AC-3,AC-4,SC-7,SC-8,SC-13",
                    "ninjaflow_ai.mil/purpose": (
                        f"ZTA micro-segmentation for {svc_name} — "
                        f"port-level ingress/egress restricted to port {svc_port}"
                    ),
                    "ninjaflow_ai.mil/zta-maturity": "optimal",
                },
            },
            "spec": {
                "podSelector": {
...
def main():
    ...
    if use_json:
        ...
        print("=" * 70)
        print("NINJAFLOW_AI Network Segmentation Generator — ZTA Micro-Segmentation")
