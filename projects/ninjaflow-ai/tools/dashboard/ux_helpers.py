# [TEMPLATE: CUI // SP-CTI]
# NINJAFLOW_AI Dashboard UX Helpers
# Server-side utilities for user-friendly display
"""
UX Helpers for the NINJAFLOW_AI Dashboard
===================================
Provides server-side utilities that make the NINJAFLOW_AI dashboard intuitive for
...
ERROR_RECOVERY = {
    ...
    "database_not_initialized": {
        "what": "The NINJAFLOW_AI database has not been set up yet",
        "why": (
            "NINJAFLOW_AI needs its database to track projects, compliance, "
            "and audit trails"
        ),
        "fix": (
            "Run this command:\n"
