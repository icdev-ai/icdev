...
@chat_api.route("/<context_id>", methods=["GET"])
def get_context(context_id):
    """Get context details with recent messages.

    Accessible at both /api/chat/contexts/<id> and /api/chat/<id>.
    """
    # Exclude sub-resource paths that have their own handlers
    if context_id in ("contexts", "diagnostics"):
