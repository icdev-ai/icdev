...
Usage:
    ...
    tracer = OTelTracer(service_name="ninjaflow_ai-builder", endpoint="http://localhost:4317")
...
logger = logging.getLogger("ninjaflow_ai.observability.otel_tracer")
...
class OTelTracer(Tracer):
    ...
    def __init__(
        ...
        self._tracer = otel_trace.get_tracer("ninjaflow_ai.observability", "0.1.0")
