...
logger = logging.getLogger("ninjaflow_ai.observability.provenance")
...
class ProvRecorder:
    ...
    def export_prov_json(self, project_id: Optional[str] = None) -> Dict:
        ...
        try:
            ...
            return {
                "prefix": {"prov": "http://www.w3.org/ns/prov#", "ninjaflow-ai": "urn:ninjaflow_ai:"},
                "entity": {
                    e["id"]: {
                        "prov:type": e["entity_type"],
                        "prov:label": e["label"],
                        "ninjaflow_ai:content_hash": e["content_hash"],
                    }
                    for e in entities
                },
                "activity": {
