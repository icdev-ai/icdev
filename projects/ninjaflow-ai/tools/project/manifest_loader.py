#!/usr/bin/env python3
# CUI // SP-CTI
"""Parse and validate ninjaflow_ai.yaml project manifests.

Reads ninjaflow_ai.yaml from a project directory, validates structure and
...
Usage:
    ...
    python tools/project/manifest_loader.py --file /path/to/ninjaflow_ai.yaml --validate
"""
...
MANIFEST_FILENAME = "ninjaflow_ai.yaml"
MANIFEST_VERSION = 1
...
def load_manifest(directory: str = None, file_path: str = None) -> dict:
    """Load and parse ninjaflow_ai.yaml from a directory or explicit path.

    Args:
        directory: Directory containing ninjaflow_ai.yaml (defaults to cwd).
        file_path: Explicit path to an ninjaflow_ai.yaml file (overrides directory).
...
def main():
    parser = argparse.ArgumentParser(
        description="Parse and validate ninjaflow_ai.yaml project manifests"
    )
    parser.add_argument("--dir", help="Project directory containing ninjaflow_ai.yaml")
    parser.add_argument("--file", help="Explicit path to ninjaflow_ai.yaml")
