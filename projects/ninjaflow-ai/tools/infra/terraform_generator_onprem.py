...
resource "kubernetes_namespace" "main" {
  metadata {
    name = var.namespace
    labels = {
      "app.kubernetes.io/managed-by" = "ninjaflow_ai-terraform"
      "ninjaflow_ai/classification"          = var.classification
      "ninjaflow_ai/environment"             = var.environment
    }
  }
}
...
# PostgreSQL database for NINJAFLOW_AI
resource "postgresql_database" "ninjaflow_ai" {
...
output "database_name" {
  ...
  value       = postgresql_database.ninjaflow_ai.name
}
"""
...
resource "docker_network" "ninjaflow_ai" {
...
def generate(project_name: str = "ninjaflow_ai", environment: str = "production",
...
def run_cli():
    ...
    parser.add_argument("--project-id", default="ninjaflow_ai", help="Project name")
