...
def generate_python(project_path: str, config: dict = None) -> list:
    ...
    project_name = config.get("project_name", "ninjaflow_ai-app")
...
def main():
    ...
    parser.add_argument("--project-name", default="ninjaflow_ai-app", help="Project name for labels")
