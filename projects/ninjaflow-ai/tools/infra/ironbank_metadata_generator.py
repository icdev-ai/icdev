...
# Generated: {timestamp}
# Generator: NINJAFLOW_AI Iron Bank Metadata Generator (D350)
apiVersion: v1
name: "{project_name}"
tags:
  - "{project_name}:latest"
...
image_author:
  name: "NINJAFLOW_AI Auto-Generator"
  email: "ninjaflow_ai@{project_slug}.mil"
...
vulnerability_report:
  - url: "{vuln_scan_url}"
    description: "SBOM and vulnerability scan — generated by NINJAFLOW_AI sbom_generator.py"
...
def generate_hardening_manifest(
    ...
    Args:
        ...
        db_path: Path to NINJAFLOW_AI database (optional).
    ...
    description = "NINJAFLOW_AI-generated hardened container"
    impact_level = "IL4"
    classification = "CUI"
    version = "1.0.0"
