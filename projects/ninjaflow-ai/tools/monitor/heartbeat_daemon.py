...
Polls on a configurable interval and runs 7 check functions against the NINJAFLOW_AI
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="NINJAFLOW_AI Heartbeat Daemon (D141) — proactive check loop"
    )
