...
"""COA (Course of Action) Generator for the NINJAFLOW_AI RICOAS Digital Program Twin.
...
def _create_simulation_for_coa(conn, coa_id, session_id, project_id, coa_type, coa_data):
    ...
    conn.execute(
        ...
        (
            ...
            "completed", "CUI", "ninjaflow_ai-simulation-engine", now,
        ),
    )
    ...
    try:
        ...
        if _HAS_AUDIT:
            log_event(
                ...
                actor="ninjaflow_ai-simulation-engine",
