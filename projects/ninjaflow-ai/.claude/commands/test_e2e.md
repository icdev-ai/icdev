...
- Use the `application_url` (default: http://localhost:5000 for ninjaflow-ai dashboard)
...
Ensure the ninjaflow-ai dashboard or target application is running before executing tests.
