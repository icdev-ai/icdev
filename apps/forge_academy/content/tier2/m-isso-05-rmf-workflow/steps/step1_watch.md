...
Watch ICDEV configure and execute a complete RMF workflow for ICDEV-Prod:

**Step 1: Categorize**
System Security Plan Section 1.1 auto-populated from existing asset inventory. Impact level confirmed: Moderate (FIPS 199). 47 applicable controls identified from NIST 800-53 Rev 5 baseline.

**Step 2: Select Controls**
47 baseline controls → 12 organization-defined parameter values set from your args/rmf_config.yaml. Control tailoring complete in 38 seconds. Overlays applied: DoD IL4 + FedRAMP Moderate.
...
Control narratives drafted for all 47 controls using your existing tool outputs as source material. Average draft length: 287 words per control. Human review flagged as required for 8 controls with gaps.
