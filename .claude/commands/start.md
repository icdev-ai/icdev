...
8. Check if the Genesis daemon (failure_triage, oracle_triage, awareness, heal, and 20+ other reflexes) is running:
   ```bash
   python -c "
import os, pathlib
