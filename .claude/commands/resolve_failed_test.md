...
2. **Context Discovery**
   ...
   - If a relevant goal exists in `goals/*.md`, read it to understand requirements
...
4. **Fix the Issue**
   ...
   - Ensure the fix aligns with the test purpose and any goal requirements
   - Do not modify unrelated code or tests
   - Maintain CUI markings on any files you modify
