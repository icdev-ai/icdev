...
#: Per-check off switches, in the order :func:`main` runs the checks. Four of
#: these predate this change and are read inside the check itself; naming all
#: nine in one table is what makes "which of these can actually refuse right
#: now" answerable without reading the whole file.
CHECK_KILL_SWITCHES = {
